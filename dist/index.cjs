...
var styled40 = require('styled-components/native');
...
var elevation = {
  ...
  md: reactNative.Platform.select({
    ...
    android: { elevation: 4 },
    web: { boxShadow: "0 4px 12px rgba(29,29,29,0.12)" },
    default: {}
  }),
  lg: reactNative.Platform.select({
    ...
    android: { elevation: 8 },
    web: { boxShadow: "0 4px 16px rgba(29,29,29,0.16)" },
    default: {}
  }),
  negative: reactNative.Platform.select({
    web: { boxShadow: "inset 0 4px 16px rgba(29,29,29,0.32)" },
    default: {}
  })
};
...
var SwiThemeProvider = ({ children, theme: override }) => /* @__PURE__ */ jsxRuntime.jsx(styled40.ThemeProvider, { theme: override ?? theme, children });
var useTheme = styled40.useTheme;
...
var iconPaths = {
  ...
  video_camera_back: {
    ...
    // Replaces the Material Symbols outline path with the exact SVG used in
    // the SWI Figma file (camera button on /admins/:id minimap, etc.).
    viewBox: "0 0 20 16",
  ...
  location_pin: {
    viewBox: "0 0 16 20",
    d: "M9.4125 9.4125C9.80417 9.02083 10 8.55 10 8C10 7.45 9.80417 6.97917 9.4125 6.5875C9.02083 6.19583 8.55 6 8 6C7.45 6 6.97917 6.19583 6.5875 6.5875C6.19583 6.97917 6 7.45 6 8C6 8.55 6.19583 9.02083 6.5875 9.4125C6.97917 9.80417 7.45 10 8 10C8.55 10 9.02083 9.80417 9.4125 9.4125ZM8 20C5.31667 17.7167 3.3125 15.5958 1.9875 13.6375C0.6625 11.6792 0 9.86667 0 8.2C0 5.7 0.804167 3.70833 2.4125 2.225C4.02083 0.741667 5.88333 0 8 0C10.1167 0 11.9792 0.741667 13.5875 2.225C15.1958 3.70833 16 5.7 16 8.2C16 9.86667 15.3375 11.6792 14.0125 13.6375C12.6875 15.5958 10.6833 17.7167 8 20Z"
  },
  heartbeat_filled: {
    viewBox: "0 0 39 31",
  ...
  // (the original SVG includes a tiny Vector_2 decoration we drop here).
  blood_pressure: {
    viewBox: "0 0 46.6667 46.6667",
    fillRule: "evenodd",
  ...
  info: {
    ...
    // Montserrat Bold 18 que o Toast info variant renderizava antes
    // (Figma 353:12284 Status Icon → Vector).
    viewBox: MATERIAL_VIEWBOX,
  ...
  wind_speed: {
    // Material Symbols `air` (wind-flow glyph: 3 horizontal lines, each with
    // a circular end-cap on the right). Used in weather-data rows in mobile
    // dashboard alert state and weather-alert modal (Figma 385:29336 /
    // 385:29316 — wind-speed-icon symbol). Figma exports this as a 20×16.667
    // raster but it matches the Material Symbols `air` outline glyph 1:1.
    viewBox: MATERIAL_VIEWBOX,
...
function useSvgId(prefix) {
  return `${prefix}-${React12.useId().replace(/[^a-zA-Z0-9_-]/g, "")}`;
}
var Icon = ({
  name,
  size = 24,
...
var Container = styled40__default.default(reactNative.View)`
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.s}px;
  overflow: hidden;
`;
var Header = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
...
`;
var TitleText = styled40__default.default.Text`
  flex: 1;
  min-width: 0;
  text-align: left;
...
`;
var Content = styled40__default.default(reactNative.View)`
  align-self: stretch;
  min-width: 0;
  margin-top: 2px;
  ...
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.s}px;
`;
var ContentText = styled40__default.default.Text`
  min-width: 0;
...
`;
var ChevronWrap = styled40__default.default(reactNative.View)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
...
var Accordion = React12.forwardRef(
  ({
    ...
    const chevronColor = theme2.content.primary;
    return /* @__PURE__ */ jsxRuntime.jsxs(
      Container,
      {
        ref,
        style: fullWidth ? { alignSelf: "stretch", width: "100%" } : { alignSelf: "flex-start", width: 320 },
        testID,
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs(
            Header,
            {
              ...
              children: [
                showIconLeft ? /* @__PURE__ */ jsxRuntime.jsx(ChevronWrap, { $open: open, children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: "keyboard_arrow_down", size: 16, color: chevronColor }) }) : null,
                /* @__PURE__ */ jsxRuntime.jsx(TitleText, { numberOfLines: 1, children: title }),
                showIconRight ? /* @__PURE__ */ jsxRuntime.jsx(ChevronWrap, { $open: open, children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: "keyboard_arrow_down", size: 16, color: chevronColor }) }) : null
              ]
            }
          ),
          open && children !== void 0 ? /* @__PURE__ */ jsxRuntime.jsx(Content, { children: typeof children === "string" ? /* @__PURE__ */ jsxRuntime.jsx(ContentText, { children }) : children }) : null
        ]
      }
    );
  }
...
var Frame = styled40__default.default(reactNative.View)`
  width: ${({ $size }) => $size}px;
  height: ${({ $size }) => $size}px;
  ...
  justify-content: center;
`;
var Initials = styled40__default.default(reactNative.Text)`
  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      Frame,
      {
        ...
        testID,
        accessibilityLabel,
        children: uri ? /* @__PURE__ */ jsxRuntime.jsx(
          reactNative.Image,
          {
            source: { uri },
...
var Row = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
`;
var AvatarSlot = styled40__default.default(reactNative.View)`
  margin-left: ${({ $marginLeft }) => $marginLeft}px;
`;
var CountBadge = styled40__default.default(reactNative.View)`
  width: ${({ $size }) => $size}px;
  height: ${({ $size }) => $size}px;
  margin-left: ${({ $marginLeft }) => $marginLeft}px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.pill}px;
  border-width: 2px;
  border-style: solid;
  border-color: ${({ theme: theme2 }) => theme2.content.dark};
  background-color: ${({ theme: theme2 }) => theme2.surface.info};
  align-items: center;
  justify-content: center;
`;
var CountText = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
...
var AvatarGroup = React12.forwardRef(
  ({
    ...
    const visibleAvatars = typeof maxVisible === "number" ? avatars.slice(0, maxVisible) : avatars;
    const total = totalCount ?? avatars.length;
    const remaining = Math.max(0, total - visibleAvatars.length);
    const overlap = -overlapFor(size);
    return /* @__PURE__ */ jsxRuntime.jsxs(Row, { ref, accessibilityLabel, testID, children: [
      visibleAvatars.map((item, idx) => /* @__PURE__ */ jsxRuntime.jsx(AvatarSlot, { $marginLeft: idx === 0 ? 0 : overlap, children: /* @__PURE__ */ jsxRuntime.jsx(
        Avatar,
        {
          uri: item.uri,
          size,
      ...
      remaining > 0 ? /* @__PURE__ */ jsxRuntime.jsx(
        CountBadge,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(CountText, { children: `+${remaining}` })
        }
      ) : null
    ] });
  }
...
var Track = styled40__default.default(reactNative.View)`
  height: 6px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.pill}px;
...
`;
var Fill = styled40__default.default(reactNative.View)`
  height: 6px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.pill}px;
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(
        reactNative.View,
        {
          ...
          style: {
            ...
            borderRadius: theme2.border.radius.pill,
            borderWidth: 1,
            borderColor: theme2.content.medium,
            backgroundColor: trackColor ?? theme2.background,
...
var Card = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  justify-content: space-between;
  padding: ${({ theme: theme2 }) => theme2.padding.sm}px ${({ theme: theme2 }) => theme2.padding.m}px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.m}px;
  background-color: ${({ theme: theme2 }) => theme2.surface.standard};
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
`;
var CardPressable = styled40__default.default(reactNative.Pressable)`
  flex-grow: 1;
  flex-shrink: 1;
  flex-direction: row;
  align-items: center;
  ...
  min-width: 0;
`;
var LeftContent = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.l}px;
  flex-shrink: 1;
`;
var IconSlot = styled40__default.default(reactNative.View)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
`;
var Divider = styled40__default.default(reactNative.View)`
  align-self: stretch;
  width: 1px;
  background-color: ${({ theme: theme2 }) => theme2.content.dark};
  opacity: 0.2;
`;
var InfoColumn = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-items: flex-start;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
  flex-shrink: 1;
`;
var Title = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var Subtitle = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var ProgressSlot = styled40__default.default(reactNative.View)`
  width: 119px;
  margin-top: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var RightContent = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
`;
var LocationButton = styled40__default.default(reactNative.Pressable)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
...
var BackgroundDotsGrid = React12.memo(function BackgroundDotsGrid2({
  columns = 27,
  color = "#65D040",
  opacity = 0.09,
  width,
  ...
  const pathData = React12.useMemo(() => buildDotsPath(columns, dots), [columns, dots]);
  return /* @__PURE__ */ jsxRuntime.jsx(
    reactNative.View,
    {
...
var Card2 = styled40__default.default(reactNative.View)`
  flex-direction: column;
  ...
  background-color: ${({ theme: theme2 }) => theme2.surface.standard};
`;
var IconSlot2 = styled40__default.default(reactNative.View)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
`;
var Value = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.title};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  ...
  text-align: center;
`;
var Label = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      Card2,
      {
        ...
        testID,
        style: fullWidth ? { alignSelf: "stretch", width: "100%" } : { alignSelf: "flex-start", width: "max-content" },
        children: [
          icon ? /* @__PURE__ */ jsxRuntime.jsx(IconSlot2, { children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: icon, size: 20, color: iconColor ?? theme2.content.primary }) }) : null,
          /* @__PURE__ */ jsxRuntime.jsx(Value, { numberOfLines: 1, children: value }),
          /* @__PURE__ */ jsxRuntime.jsx(Label, { numberOfLines: 1, children: label })
        ]
      }
    );
  }
...
var containerBackground = ({
  ...
  if ($variant === "contained") return $backgroundColor ?? theme2.surface.primary;
  if ($variant === "surface") return $backgroundColor ?? theme2.surface.standard;
  if ($variant === "outline") {
...
var containerBorderColor = ({
  ...
  if ($variant === "outline") return theme2.content.primaryLight;
  return "transparent";
};
var borderWidthPx = ($borderWidth, theme2) => {
  if (typeof $borderWidth === "number") return $borderWidth;
  if ($borderWidth === "s") return theme2.border.size.s;
  return theme2.border.size.m;
};
var Container2 = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
  justify-content: center;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
  ...
  border-width: ${({ $borderWidth, theme: theme2 }) => borderWidthPx($borderWidth, theme2)}px;
...
`;
var HoverOverlay = styled40__default.default(reactNative.View)`
  position: absolute;
  inset: 0;
  border-radius: ${({ $shape, theme: theme2 }) => radius($shape, theme2)}px;
  ...
  pointer-events: none;
`;
var PressedOverlay = styled40__default.default(reactNative.View)`
  position: absolute;
  inset: 0;
  border-radius: ${({ $shape, theme: theme2 }) => radius($shape, theme2)}px;
  pointer-events: none;
...
var Label2 = styled40__default.default.Text`
...
`;
var IconSlot3 = styled40__default.default(reactNative.View)`
  align-items: center;
  justify-content: center;
`;
...
var Row2 = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: flex-end;
  gap: ${({ theme: theme2 }) => theme2.gap.sm}px;
`;
var Bubble = styled40__default.default(reactNative.View)`
  flex: 1;
  min-width: 0;
  flex-direction: column;
  background-color: ${({ theme: theme2 }) => theme2.surface.standard};
...
`;
var BubbleInner = styled40__default.default(reactNative.View)`
  flex-direction: column;
  gap: 10px;
  align-items: ${({ $position }) => $position === "left" ? "flex-end" : "flex-start"};
`;
var TopRow = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  width: 100%;
`;
var MessageText = styled40__default.default.Text`
  flex: 1;
  min-width: 0;
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
...
`;
var MenuButton = styled40__default.default(reactNative.Pressable)`
  width: 16px;
  height: 16px;
  align-items: center;
  justify-content: center;
`;
var TimeText = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.s}px;
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
...
var ChatBubble = React12.forwardRef(
  ({
    ...
    const avatar = avatarUri ? /* @__PURE__ */ jsxRuntime.jsx(Avatar, { uri: avatarUri, size: "m" }) : null;
    const menu = onMenuPress ? /* @__PURE__ */ jsxRuntime.jsx(
      MenuButton,
      {
        onPress: onMenuPress,
        accessibilityRole: "button",
        accessibilityLabel: "Mensagem op\xE7\xF5es",
        children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: "more_vert", size: 16, color: theme2.content.dark })
      }
    ) : null;
    return /* @__PURE__ */ jsxRuntime.jsxs(
      Row2,
      {
        ...
        children: [
          !isLeft ? avatar : null,
          /* @__PURE__ */ jsxRuntime.jsx(Bubble, { $position: position, style: elevation.md, children: /* @__PURE__ */ jsxRuntime.jsxs(BubbleInner, { $position: position, children: [
            /* @__PURE__ */ jsxRuntime.jsx(TopRow, { children: !isLeft ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(MessageText, { $position: position, children: message }),
              menu
            ] }) : /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
              menu,
              /* @__PURE__ */ jsxRuntime.jsx(MessageText, { $position: position, children: message })
            ] }) }),
            /* @__PURE__ */ jsxRuntime.jsx(TimeText, { children: time })
          ] }) }),
          isLeft ? avatar : null
        ]
      }
...
var Container3 = styled40__default.default(reactNative.Pressable)`
  height: 60px;
  flex-direction: row;
  align-items: center;
  justify-content: space-between;
  ...
  background-color: ${({ theme: theme2 }) => theme2.surface.standard};
`;
var AvatarRow = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  flex: 1;
  min-width: 0;
`;
var TextStack = styled40__default.default(reactNative.View)`
  flex: 1;
  min-width: 0;
`;
var Name = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
...
`;
var Subtitle2 = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      Container3,
      {
        ...
        testID,
        style: fullWidth ? { alignSelf: "stretch", width: "100%" } : { alignSelf: "flex-start", width: 196 },
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs(AvatarRow, { children: [
            avatarUri ? /* @__PURE__ */ jsxRuntime.jsx(Avatar, { uri: avatarUri, size: "m" }) : null,
            /* @__PURE__ */ jsxRuntime.jsxs(TextStack, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(Name, { numberOfLines: 1, children: name }),
...
var rowBackground = ({
  ...
  if ($focused) return theme2.surface.high;
  if ($hovered) return theme2.surface.medium;
  if ($hasValue) return theme2.surface.medium;
  return theme2.surface.standard;
};
var Container4 = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-self: stretch;
`;
var Row3 = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
  justify-content: space-between;
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
  ...
  ${({ $disabled, theme: theme2 }) => $disabled ? styled40.css`
          border-width: ${theme2.border.size.s}px;
          border-color: ${theme2.content.disable};
        ` : ""};
`;
var HoverOverlay2 = styled40__default.default(reactNative.View)`
  position: absolute;
  inset: 0;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.m}px;
  background-color: ${({ theme: theme2 }) => theme2.surface.hover};
  pointer-events: none;
`;
styled40__default.default(reactNative.View)`
  position: absolute;
  top: -2px;
  left: -2px;
  right: -2px;
  ...
  pointer-events: none;
`;
var StyledInput = styled40__default.default(reactNative.TextInput)`
  flex: 1;
  min-width: 0;
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  ...
  outline-style: none;
`;
var IconSlot4 = styled40__default.default(reactNative.View)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
`;
var IconButton = styled40__default.default(reactNative.Pressable)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
...
var SearchInput = React12.forwardRef(
  ({
    ...
    const iconColor = disabled ? theme2.content.disable : theme2.content.dark;
    return /* @__PURE__ */ jsxRuntime.jsx(Container4, { children: /* @__PURE__ */ jsxRuntime.jsxs(
      Row3,
      {
        $focused: focused,
        $hovered: hovered,
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            StyledInput,
            {
              ...
              placeholder,
              placeholderTextColor: disabled ? theme2.content.disable : theme2.content.dark,
              editable: !disabled,
              onFocus: (e) => {
                setFocused(true);
                onFocus?.(e);
          ...
          showClose ? /* @__PURE__ */ jsxRuntime.jsx(
            IconButton,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: "close", size: 24, color: iconColor })
            }
          ) : /* @__PURE__ */ jsxRuntime.jsx(IconSlot4, { children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: "search", size: 24, color: iconColor }) }),
          hovered && !focused && !disabled ? /* @__PURE__ */ jsxRuntime.jsx(HoverOverlay2, {}) : null
        ]
      }
    ) });
  }
...
var Container5 = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-items: stretch;
  gap: ${({ theme: theme2 }) => theme2.gap.sm}px;
  padding: ${({ theme: theme2 }) => theme2.padding.s}px;
...
`;
var ListScroll = styled40__default.default(reactNative.ScrollView)`
  align-self: stretch;
  max-height: 296px;
...
`;
var ListInner = styled40__default.default(reactNative.View)`
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      Container5,
      {
        ...
        accessibilityLabel,
        testID,
        style: fullWidth ? { alignSelf: "stretch", width: "100%" } : { alignSelf: "flex-start", width: 228 },
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            SearchInput,
            {
...
var Container6 = styled40__default.default(reactNative.View)`
  flex-direction: column;
  ...
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
`;
var TitleText2 = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.title};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
...
`;
var DonutWrapper = styled40__default.default(reactNative.View)`
  width: ${({ $size }) => $size}px;
  height: ${({ $size }) => $size}px;
  align-items: center;
  justify-content: center;
  position: relative;
`;
var ArcSlot = styled40__default.default(reactNative.View)`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
  ...
  justify-content: center;
`;
var Center = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-items: center;
  justify-content: center;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
  width: 96px;
`;
var ValueText = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.title};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ $size }) => $size}px;
...
var LabelText = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  ...
  text-align: center;
`;
var Caption = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  text-align: center;
`;
var LocationButton2 = styled40__default.default(reactNative.Pressable)`
  position: absolute;
  top: 0;
  right: 0;
  width: ${({ $size }) => $size}px;
...
var Card3 = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
  justify-content: space-between;
...
`;
var LeftCluster = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.l}px;
  ...
  min-width: 0;
`;
var UserInfo = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  ...
  min-width: 0;
`;
var TextStack2 = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-items: flex-start;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var Name2 = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var Sector = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var ProgressSlot2 = styled40__default.default(reactNative.View)`
  width: 119px;
`;
var Divider2 = styled40__default.default(reactNative.View)`
  width: 1px;
  align-self: stretch;
  background-color: ${({ theme: theme2 }) => theme2.content.medium};
`;
var HealthOverview = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-items: flex-start;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  ...
  width: 110px;
`;
var Stat = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.sm}px;
`;
var StatText = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
  ...
  white-space: nowrap;
`;
var LocationButton3 = styled40__default.default(reactNative.Pressable)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(LeftCluster, { children: [
            /* @__PURE__ */ jsxRuntime.jsxs(UserInfo, { children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(TextStack2, { children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(ProgressSlot2, { children: /* @__PURE__ */ jsxRuntime.jsx(ProgressBar, { value: progress, color: theme2.surface.info }) })
              ] })
            ] }),
...
var Card4 = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  justify-content: space-between;
...
`;
var YearText = styled40__default.default.Text`
...
`;
var DateText = styled40__default.default.Text`
  color: ${({ theme: theme2, $past }) => $past ? theme2.content.medium : theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  ...
  `}
`;
var ExamLink = styled40__default.default(reactNative.Pressable)`
  ${({ $compact }) => $compact ? `
    flex: 1;
    align-items: flex-start;
    justify-content: center;
  ...
  `}
`;
var ExamLinkText = styled40__default.default.Text`
...
`;
var CompactActionButton = styled40__default.default(reactNative.Pressable)`
  ...
  justify-content: center;
`;
var DownloadIconSlot = styled40__default.default(reactNative.View)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            ExamLink,
            {
              $compact: compact,
              onPress: onExamPress,
              accessibilityRole: onExamPress ? "link" : void 0,
              accessibilityLabel: onExamPress ? examName : void 0,
              children: /* @__PURE__ */ jsxRuntime.jsx(
                ExamLinkText,
                {
                  $compact: compact,
...
var Row4 = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  align-self: flex-start;
`;
var VitalsCard = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-items: flex-start;
  justify-content: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  padding-left: ${({ theme: theme2 }) => theme2.padding.xl}px;
  padding-right: 56px;
  padding-vertical: ${({ theme: theme2 }) => theme2.padding.sm}px;
  border-width: ${({ theme: theme2 }) => theme2.border.size.s}px;
  border-style: solid;
  border-color: ${({ theme: theme2 }) => theme2.content.medium};
  border-top-left-radius: ${({ theme: theme2 }) => theme2.border.radius.pill}px;
  border-bottom-left-radius: ${({ theme: theme2 }) => theme2.border.radius.pill}px;
  margin-right: -32px;
`;
var StatsRow = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: 10px;
`;
var StatItem = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var StatText2 = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
`;
var StatValueBold = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
`;
var ProgressSlot3 = styled40__default.default(reactNative.View)`
  width: 138px;
`;
      ...
      Row4,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs(VitalsCard, { children: [
            /* @__PURE__ */ jsxRuntime.jsxs(StatsRow, { children: [
...
var Logo = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    Icon,
    {
      ...
      width,
      height,
      color: color ?? theme2.content.dark,
      testID,
...
var Bar = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  justify-content: space-between;
  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      Bar,
      {
        ...
        style: fullWidth ? { alignSelf: "stretch", width: "100%" } : { alignSelf: "flex-start" },
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(Logo, { type: logoType, size: logoSize }),
          /* @__PURE__ */ jsxRuntime.jsx(
            HeaderUserInfo,
            {
              bpm,
...
// src/components/HeartrateStatus/HeartrateStatus.paths.ts
var CIRCLE = "M20.753 10.377C20.753 12.4294 20.1444 14.4357 19.0041 16.1423C17.8638 17.8488 16.2431 19.1788 14.3469 19.9642C12.4507 20.7496 10.3642 20.955 8.35121 20.5545C6.33824 20.1541 4.48924 19.1656 3.03803 17.7143C1.58682 16.2629 0.598583 14.4138 0.198297 12.4008C-0.201989 10.3878 0.00365341 8.30133 0.789217 6.4052C1.57478 4.50907 2.90498 2.88847 4.6116 1.74835C6.31822 0.608235 8.32461 -0.000197737 10.377 4.82058e-08C11.7397 4.18773e-08 13.089 0.268416 14.348 0.789922C15.6069 1.31143 16.7508 2.07581 17.7143 3.03941C18.6778 4.00302 19.4421 5.14698 19.9635 6.40597C20.4849 7.66496 20.7532 9.01432 20.753 10.377Z";
var CHECK_SYMBOL = "M15.025 5L8.799 11.226L6.205 8.63196L4 10.811L6.594 13.405L8.669 15.48L8.799 15.58L17.23 7.17493L15.025 5Z";
var ALERT_SYMBOL = "M8.92596 3.90466C9.57138 3.90496 10.2103 4.03347 10.8056 4.28273C11.401 4.53199 11.9409 4.89703 12.394 5.35666C12.8616 5.812 13.2315 6.35795 13.481 6.96111C13.7305 7.56428 13.8543 8.212 13.845 8.86466C13.8477 9.50085 13.7244 10.1313 13.482 10.7195C13.2396 11.3077 12.8831 11.8421 12.433 12.2917H13.482C13.6529 12.2963 13.8231 12.2666 13.9823 12.2042C14.1415 12.1419 14.2866 12.0482 14.409 11.9287C14.6618 11.6694 14.8051 11.3228 14.809 10.9607V8.82366C14.646 8.71134 14.5133 8.56062 14.4224 8.38482C14.3315 8.20901 14.2854 8.01354 14.288 7.81566C14.2895 7.48462 14.4217 7.16759 14.6558 6.93352C14.8899 6.69944 15.2069 6.56723 15.538 6.56566C15.869 6.56723 16.186 6.69944 16.4201 6.93352C16.6542 7.16759 16.7864 7.48462 16.788 7.81566C16.7842 8.00854 16.7391 8.19838 16.6556 8.37229C16.5721 8.54621 16.4522 8.70014 16.304 8.82366V10.9607C16.2987 11.7181 15.9943 12.4428 15.457 12.9767C15.1983 13.2363 14.8901 13.4415 14.5507 13.5799C14.2112 13.7184 13.8475 13.7873 13.481 13.7827H8.92596C8.2733 13.792 7.62559 13.6682 7.02242 13.4187C6.41926 13.1692 5.87331 12.7993 5.41796 12.3317C4.95834 11.8786 4.5933 11.3387 4.34404 10.7433C4.09478 10.148 3.96627 9.50907 3.96596 8.86466C3.96644 7.5482 4.48862 6.28664 5.41796 5.35566C6.34895 4.42631 7.61051 3.90414 8.92596 3.90366V3.90466ZM6.58796 15.3557L11.224 15.3557V16.8477H6.58796V15.3557ZM8.92596 12.2917C9.37705 12.3007 9.82507 12.2157 10.2415 12.0422C10.658 11.8687 11.0338 11.6103 11.345 11.2837C11.6685 10.9701 11.9248 10.5939 12.0981 10.178C12.2714 9.76205 12.3581 9.31519 12.353 8.86466C12.3583 8.408 12.2718 7.95493 12.0986 7.53235C11.9255 7.10976 11.6692 6.72627 11.345 6.40466C10.7007 5.76647 9.8328 5.40483 8.92596 5.39666C8.00698 5.40445 7.12619 5.76536 6.46596 6.40466C5.82667 7.06488 5.46576 7.94567 5.45796 8.86466C5.46614 9.77149 5.82778 10.6394 6.46596 11.2837C6.78758 11.6079 7.17107 11.8642 7.59365 12.0373C8.01624 12.2105 8.46931 12.297 8.92596 12.2917ZM8.92596 7.89666C9.05042 7.89925 9.17314 7.92636 9.28711 7.97643C9.40108 8.02651 9.50406 8.09855 9.59016 8.18846C9.67626 8.27837 9.74379 8.38437 9.78888 8.50039C9.83397 8.61642 9.85575 8.7402 9.85296 8.86466C9.85499 8.98695 9.8324 9.1084 9.78653 9.22179C9.74066 9.33518 9.67246 9.43818 9.58597 9.52466C9.49948 9.61115 9.39648 9.67936 9.2831 9.72522C9.16971 9.77109 9.04826 9.79368 8.92596 9.79166C8.80151 9.79444 8.67773 9.77267 8.5617 9.72757C8.44567 9.68248 8.33968 9.61495 8.24977 9.52885C8.15986 9.44275 8.08781 9.33977 8.03774 9.2258C7.98767 9.11184 7.96056 8.98911 7.95796 8.86466C7.96133 8.60897 8.0644 8.36471 8.24521 8.1839C8.42602 8.00309 8.67028 7.90002 8.92596 7.89666Z";
var HEARTRATE_STATUS_PATHS = {
  check: { width: 21, height: 22, circle: CIRCLE, symbol: CHECK_SYMBOL },
  low: { width: 21, height: 22, circle: CIRCLE, symbol: CHECK_SYMBOL },
  alert: { width: 21, height: 22, circle: CIRCLE, symbol: ALERT_SYMBOL }
};

// src/components/HeartrateStatus/HeartrateStatus.theme.ts
var conditionColor = (theme2, condition) => {
  switch (condition) {
    case "low":
...
// src/components/HeartStatus/HeartStatus.paths.ts
var HEART_STATUS_CANVAS = { width: 42, height: 36 };
var HEART_STATUS_BADGE_OFFSET = { x: 21, y: 0 };
var HEART_PATH = "M27.912 9.849C26.2812 8.52861 24.2089 7.87863 22.1162 8.03113C20.0234 8.18362 18.0672 9.12715 16.645 10.67L15.455 11.896L14.265 10.67C12.8429 9.12715 10.8867 8.18362 8.79391 8.03113C6.70115 7.87863 4.62884 8.52861 2.99804 9.849C2.10841 10.6173 1.38431 11.5585 0.869739 12.6153C0.355169 13.6722 0.0608804 14.8226 0.00476026 15.9968C-0.0513599 17.1709 0.131861 18.3442 0.543286 19.4453C0.954711 20.5464 1.58575 21.5523 2.39804 22.402L14.088 34.467C14.2648 34.6516 14.477 34.7985 14.712 34.8989C14.9471 34.9993 15.2 35.051 15.4555 35.051C15.7111 35.051 15.964 34.9993 16.199 34.8989C16.4341 34.7985 16.6463 34.6516 16.823 34.467L28.507 22.403C29.3205 21.554 29.9526 20.5483 30.3649 19.4473C30.7773 18.3462 30.9612 17.1727 30.9055 15.9982C30.8499 14.8238 30.5558 13.6729 30.0411 12.6158C29.5265 11.5586 28.8021 10.6173 27.912 9.849Z";
var HeartStatus = ({
  condition = "check",
  size,
  testID,
...
var Container7 = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
  width: 100%;
  background-color: ${({ theme: theme2 }) => theme2.surface.standard};
  ...
  opacity: ${({ $disabled }) => $disabled ? 0.5 : 1};
`;
var LeftSlot = styled40__default.default(reactNative.View)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
`;
var LabelSlot = styled40__default.default(reactNative.View)`
  flex: 1;
`;
var RightSlot = styled40__default.default(reactNative.View)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
...
var Container8 = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  opacity: ${({ $disabled }) => $disabled ? 0.5 : 1};
`;
var Ring = styled40__default.default(reactNative.View)`
  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      Container8,
      {
        ...
        testID,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(Ring, { $size: size, children: checked ? /* @__PURE__ */ jsxRuntime.jsx(Dot, { $size: size }) : null }),
          /* @__PURE__ */ jsxRuntime.jsx(Label3, { children: label })
        ]
      }
    );
  }
...
// src/components/RadioGroup/RadioGroup.selection.ts
var isSelected = (optionValue, current) => {
  if (current === null || current === void 0) return false;
  if (optionValue === "") return false;
  return optionValue === current;
};

// src/utils/descriptionColor.ts
...
var Container9 = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-self: stretch;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var Label4 = styled40__default.default.Text`
  ...
  color: ${({ $disabled, theme: theme2 }) => $disabled ? theme2.content.disable : theme2.content.dark};
`;
var Options = styled40__default.default(reactNative.View)`
  flex-direction: row;
  flex-wrap: wrap;
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
`;
var Description = styled40__default.default.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  color: ${(props) => descriptionColor(props)};
`;
var RadioGroup = React12.forwardRef(
  ({
    label,
    options,
    value,
    ...
    Container9,
    {
      ...
      testID,
      children: [
        label ? /* @__PURE__ */ jsxRuntime.jsx(Label4, { $disabled: disabled, children: label }) : null,
        /* @__PURE__ */ jsxRuntime.jsx(Options, { children: options.map((option) => /* @__PURE__ */ jsxRuntime.jsx(
          Radio,
          {
            label: option.label,
...
var Container10 = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  opacity: ${({ $disabled }) => $disabled ? 0.5 : 1};
`;
var Box = styled40__default.default(reactNative.View)`
  width: ${({ $size }) => SIZE2[$size].box}px;
  height: ${({ $size }) => SIZE2[$size].box}px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.s}px;
  border-width: ${({ $size }) => SIZE2[$size].border}px;
  border-color: ${({ theme: theme2 }) => theme2.content.secondary};
  align-items: center;
  justify-content: center;
  background-color: transparent;
`;
var Check = styled40__default.default.Text`
  ...
  text-align: center;
`;
var Label5 = styled40__default.default.Text`
  flex: 1;
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      Container10,
      {
        ...
        testID,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(Box, { $size: size, children: checked ? /* @__PURE__ */ jsxRuntime.jsx(Check, { $size: size, children: "\u2713" }) : null }),
          label ? /* @__PURE__ */ jsxRuntime.jsx(Label5, { $size: size, children: label }) : null
        ]
      }
    );
  }
...
var Container11 = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-self: stretch;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
...
var Label6 = styled40__default.default.Text`
  ...
  color: ${({ $disabled, theme: theme2 }) => $disabled ? theme2.content.disable : theme2.content.dark};
`;
var Row5 = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
  padding: ${({ theme: theme2 }) => theme2.padding.sm}px;
  ...
  ${({ $disabled, theme: theme2 }) => $disabled ? styled40.css`
        ...
        ` : ""};
`;
var HoverOverlay3 = styled40__default.default(reactNative.View)`
  position: absolute;
  inset: 0;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.m}px;
  background-color: ${({ theme: theme2 }) => theme2.surface.hover};
...
styled40__default.default(reactNative.View)`
  ...
  pointer-events: none;
`;
var StyledInput2 = styled40__default.default(reactNative.TextInput)`
  flex: 1;
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
  ...
  outline-style: none;
`;
var IconSlot5 = styled40__default.default(reactNative.View)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
  padding: ${({ theme: theme2 }) => theme2.padding.xs}px;
`;
var BottomRow = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: flex-start;
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
`;
var Description2 = styled40__default.default.Text`
  flex-shrink: 1;
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  color: ${(props) => descriptionColor(props)};
`;
var Counter = styled40__default.default.Text`
  margin-left: auto;
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
...
var Input = React12.forwardRef(
  ({
    ...
    const [focused, setFocused] = React12.useState(false);
    const [hovered, setHovered] = React12.useState(false);
    const [innerLength, setInnerLength] = React12.useState(
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(Container11, { children: [
      label ? /* @__PURE__ */ jsxRuntime.jsx(Label6, { $disabled: disabled, $weight: labelWeight, children: label }) : null,
      /* @__PURE__ */ jsxRuntime.jsxs(
        Row5,
        {
          $focused: focused,
          ...
          children: [
            ...
            iconRight ? /* @__PURE__ */ jsxRuntime.jsx(IconSlot5, { children: iconRight }) : null,
            hovered && !focused && !disabled ? /* @__PURE__ */ jsxRuntime.jsx(HoverOverlay3, {}) : null
          ]
        }
      ),
      description || counterLabel ? /* @__PURE__ */ jsxRuntime.jsxs(BottomRow, { children: [
        description ? /* @__PURE__ */ jsxRuntime.jsx(Description2, { $disabled: disabled, $variant: descriptionVariant, children: description }) : null,
        counterLabel ? /* @__PURE__ */ jsxRuntime.jsx(Counter, { $disabled: disabled, children: counterLabel }) : null
      ] }) : null
    ] });
  }
);
...
var Container12 = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-self: stretch;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var Label7 = styled40__default.default.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
  color: ${({ $disabled, theme: theme2 }) => $disabled ? theme2.content.disable : theme2.content.dark};
`;
var Trigger = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
  padding: ${({ theme: theme2 }) => theme2.padding.sm}px;
...
`;
var TriggerLabel = styled40__default.default.Text`
  flex: 1;
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
...
`;
styled40__default.default.Text`
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  color: ${({ $disabled, theme: theme2 }) => $disabled ? theme2.content.disable : theme2.content.dark};
`;
var Panel = styled40__default.default(reactNative.View)`
...
`;
var OptionsList = styled40__default.default(reactNative.View)`
  flex-direction: column;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var OptionRow = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
  padding-horizontal: ${({ theme: theme2 }) => theme2.padding.s}px;
...
`;
var OptionLabel = styled40__default.default.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
  color: ${({ theme: theme2 }) => theme2.content.dark};
`;
var Description3 = styled40__default.default.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  color: ${(props) => descriptionColor(props)};
...
var Combobox = React12.forwardRef(
  ({
    ...
    React12.useImperativeHandle(ref, () => triggerRef.current, []);
    const [triggerRect, setTriggerRect] = React12.useState(null);
    ...
    const openMenu = React12.useCallback(() => {
      if (disabled) return;
    ...
    const closeMenu = React12.useCallback(() => {
      setOpen(false);
    }, []);
    React12.useEffect(() => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(Container12, { testID, children: [
      label ? /* @__PURE__ */ jsxRuntime.jsx(Label7, { $disabled: disabled, children: label }) : null,
      /* @__PURE__ */ jsxRuntime.jsxs(
        Trigger,
        {
          ref: triggerRef,
      ...
      description ? /* @__PURE__ */ jsxRuntime.jsx(Description3, { $disabled: disabled, $variant: descriptionVariant, children: description }) : null
    ] });
  }
);
...
var Container13 = styled40__default.default(reactNative.Pressable)`
  align-self: flex-start;
`;
var Body = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  justify-content: center;
  padding-vertical: ${({ theme: theme2 }) => theme2.padding.xs}px;
  ...
  overflow: hidden;
`;
var Label8 = styled40__default.default.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  color: ${(props) => textColor(props)};
`;
var HoverOverlay4 = styled40__default.default(reactNative.View)`
  position: absolute;
  inset: 0;
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      Container13,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(Body, { $state: state, $variant: variant, $colorScheme: colorScheme, children: [
          /* @__PURE__ */ jsxRuntime.jsx(Label8, { $state: state, $variant: variant, $colorScheme: colorScheme, children: label }),
...
var ChipGroup = ({
  ...
  const handlePress = (option) => {
    ...
    if (value === void 0) setSelected(next);
    onChange?.(mode === "single" ? next[0] ?? "" : next);
  };
  return /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [{ flexDirection: "row", flexWrap: "wrap", gap: 8 }, style], children: options.map((option) => /* @__PURE__ */ jsxRuntime.jsx(
    Chip,
    {
      label: option,
      variant,
...
var Container14 = styled40__default.default(reactNative.View)`
  align-self: stretch;
  border-width: 1px;
  border-style: dashed;
  border-color: ${({ theme: theme2 }) => theme2.content.primary};
  ...
  align-items: center;
`;
var HelperText = styled40__default.default.Text`
  align-self: stretch;
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
`;
var PreviewSlot = styled40__default.default(reactNative.View)`
  align-self: stretch;
  height: 56px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.s}px;
  overflow: hidden;
  background-color: ${({ theme: theme2 }) => theme2.surface.medium};
`;
var RemoveButton = styled40__default.default(reactNative.Pressable)`
  position: absolute;
  top: 4px;
  right: 4px;
  width: 16px;
  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      Container14,
      {
        ...
        testID,
        children: [
          hasValue ? /* @__PURE__ */ jsxRuntime.jsxs(PreviewSlot, { children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              reactNative.Image,
              {
            ...
            onRemove && !disabled ? /* @__PURE__ */ jsxRuntime.jsx(
              RemoveButton,
              {
                ...
                onPress: onRemove,
                children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: "close", size: 10, color: theme2.content.dark })
              }
            ) : null
          ] }) : /* @__PURE__ */ jsxRuntime.jsx(ProgressBar, { value: progress ?? 0, disabled }),
          /* @__PURE__ */ jsxRuntime.jsx(HelperText, { children: helperText }),
          showTakePhoto ? /* @__PURE__ */ jsxRuntime.jsx(
            Button,
            {
...
var ExpandedBar = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
  ...
  align-self: flex-end;
`;
var TitleText3 = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var Divider3 = styled40__default.default(reactNative.View)`
  width: 1px;
  height: 40px;
  background-color: ${({ theme: theme2 }) => theme2.content.medium};
`;
var SearchSlot = styled40__default.default(reactNative.View)`
  width: 284px;
`;
var OptionsRow = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
  padding: ${({ theme: theme2 }) => theme2.padding.sm}px;
`;
var TrailingButton = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
  justify-content: center;
  padding: ${({ theme: theme2 }) => theme2.padding.sm}px;
...
`;
var CollapsedButton = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
  justify-content: center;
  padding: ${({ theme: theme2 }) => theme2.padding.sm}px;
  ...
  ({
    ...
    if (!expanded) {
      return /* @__PURE__ */ jsxRuntime.jsx(
        CollapsedButton,
        {
          ...
          testID,
          style: elevation.md,
          children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: iconName, size: 24, color: theme2.content.dark })
        }
      );
    }
    const renderCenter = () => {
      if (variant === "heatmap") {
        return /* @__PURE__ */ jsxRuntime.jsx(OptionsRow, { children: options?.map((opt) => /* @__PURE__ */ jsxRuntime.jsx(
          Checkbox,
          {
            label: opt.label,
            size: "s",
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(SearchSlot, { children: /* @__PURE__ */ jsxRuntime.jsx(
        SearchInput,
        {
          value: searchValue,
          onChangeText: onSearchChange,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      ExpandedBar,
      {
        ...
        testID,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(TitleText3, { numberOfLines: 1, children: resolvedTitle }),
...
var Container15 = styled40__default.default(reactNative.View)`
  align-items: center;
  justify-content: flex-start;
`;
var TailWrapper = styled40__default.default(reactNative.View)`
  margin-top: -2px;
`;
var CameraBody = styled40__default.default(reactNative.View)`
  ${({ $size, theme: theme2 }) => styled40.css`
    width: ${$size}px;
    height: ${$size}px;
  ...
  `}
`;
var BadgeBody = styled40__default.default(reactNative.View)`
  ${({ $size, $fill }) => styled40.css`
    width: ${$size}px;
    height: ${$size}px;
...
var LocationPin = React12.forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(Container15, { ref, testID, accessibilityLabel: name, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(TailWrapper, { children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: "pin_tail", color: resolvedTail, size: tailSize }) })
    ] });
  }
);
...
var Container16 = styled40__default.default(reactNative.Pressable)`
...
`;
var HoverOverlay5 = styled40__default.default(reactNative.View)`
  position: absolute;
  inset: 0;
  border-radius: ${({ $variant, theme: theme2 }) => $variant === "compact" ? "0px" : `${theme2.border.radius.m}px`};
  background-color: ${({ theme: theme2 }) => theme2.surface.hover};
  pointer-events: none;
`;
var LabelGroup = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
`;
var IconSlot6 = styled40__default.default(reactNative.View)`
  width: 22px;
  height: 22px;
  align-items: center;
  justify-content: center;
`;
var Label9 = styled40__default.default.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
...
`;
var Divider4 = styled40__default.default(reactNative.View)`
  width: 2px;
  height: 100%;
  border-radius: 2px;
  background-color: ${(props) => dividerColor(props)};
`;
var BadgeOverlay = styled40__default.default(reactNative.View)`
  position: absolute;
  top: 0;
      ...
      Container16,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(LabelGroup, { children: [
            ...
            !isMinimal ? /* @__PURE__ */ jsxRuntime.jsx(Label9, { ...stateProps, children: label }) : null
          ] }),
...
var Anchor = styled40__default.default(reactNative.View)`
  position: relative;
  align-self: flex-start;
`;
var Panel2 = styled40__default.default(reactNative.View)`
  position: absolute;
  z-index: 100;
  ...
  box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.4);
`;
var ItemList = styled40__default.default(reactNative.View)`
  flex-direction: column;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var ItemRow = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  padding-horizontal: ${({ theme: theme2 }) => theme2.padding.s}px;
...
`;
var ItemLabel = styled40__default.default.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
  color: ${({ $color }) => $color};
`;
var Separator = styled40__default.default(reactNative.View)`
  height: 1px;
  background-color: ${({ theme: theme2 }) => theme2.content.medium};
...
var Popover = React12.forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(Anchor, { ref, testID, children: [
      /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { ref: triggerRef, children: trigger }),
      visible ? /* @__PURE__ */ jsxRuntime.jsx(
        Panel2,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(ItemList, { children })
        }
      ) : null
    ] });
  }
...
var PopoverItem = React12.forwardRef(
  ({ label, icon, tone = "default", disabled = false, onPress, accessibilityLabel, testID }, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      ItemRow,
      {
        ...
        testID,
        children: [
          icon ? /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: icon, size: 18, color }) : null,
          /* @__PURE__ */ jsxRuntime.jsx(ItemLabel, { $color: color, children: label })
        ]
      }
    );
  }
...
var Container17 = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-items: stretch;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
`;
...
// src/components/Silhouette/Silhouette.paths.ts
var SILHOUETTE_PATHS = {
  male: {
    width: 97,
    height: 320,
    body: "M93.971 166.586L93.7423 160.383V153.351C93.6303 142.861 95.2275 128.845 94.0774 120.714C93.3254 115.4 91.267 108.25 91.2322 103.977C91.0647 83.7268 91.2698 72.011 87.5503 62.4711C83.9785 53.3115 73.3789 52.4033 73.3789 52.4033C68.3576 51.9553 59.5745 47.7416 59.5745 47.7416C57.902 45.51 56.0404 37.7537 56.8752 34.4737C57.1124 33.541 58.4526 32.1236 59.0512 31.2934C59.9312 30.0718 60.7679 26.884 61.3025 24.4905C61.4522 24.5884 61.6056 24.6543 61.7665 24.6543C62.8141 24.6543 63.664 22.4585 63.664 19.746C63.664 17.3564 63.0042 15.3695 62.1289 14.9309L61.6451 10.7079C60.5938 2.29272 52.8112 0 48.3867 0C43.9621 0 36.1029 1.37131 34.8665 10.7079L34.565 14.9074C33.6477 15.2538 32.9418 17.2782 32.9418 19.746C32.9418 22.4585 33.791 24.6543 34.8389 24.6543C34.9911 24.6543 35.1374 24.5959 35.279 24.5094C35.7002 26.6063 36.2731 29.2868 36.7355 30.7918C37.0572 31.8384 38.7944 33.6248 39.1342 34.725C40.1055 37.8685 38.8717 45.51 37.1981 47.7416C37.1981 47.7416 28.4153 51.9553 23.394 52.4033C23.394 52.4033 12.7942 53.3115 9.22285 62.4711C5.50376 72.011 5.70809 83.7268 5.54084 103.977C5.50555 108.25 3.44746 115.4 2.69564 120.714C1.54524 128.845 3.14299 142.861 3.03052 153.351V160.383L2.80181 166.586L0 186.05C0 186.05 0.825327 191.658 4.61952 198.421C4.61952 198.421 7.58679 201.556 6.76222 197.432L5.60927 187.039L9.07358 179.949C9.07358 179.949 10.0637 184.235 9.40262 187.039L8.74163 190.835C8.74163 190.835 11.2155 192.152 12.7004 188.028C12.7004 188.028 16.3303 176.979 11.5479 168.566L12.5692 160.268L18.8178 130.06C18.8178 130.06 20.9384 124.564 20.2689 115.192C20.2689 115.192 24.3421 107.222 23.2723 79.6157C23.209 78.3413 23.1705 77.6176 23.1705 77.6176C23.2314 78.1239 23.2631 78.8044 23.2723 79.6157C23.634 86.8741 24.8237 112.406 24.5539 128.953C24.441 135.867 23.5553 139.021 22.3892 149.166C20.7469 163.452 17.3774 175.716 20.1575 190.673C20.1575 190.673 23.951 207.298 25.2903 213.882C25.2903 213.882 24.8715 227.487 24.8715 232.85C24.8715 241.497 25.5906 249.605 25.7921 256.949C25.9358 262.183 31.5098 290.008 29.5389 296.236C28.8811 298.315 28.4697 300.968 28.4697 300.968C26.8811 305.879 21.9226 311.306 20.1664 313.196C16.3471 317.313 25.2991 322.122 31.9937 318.997C34.2091 317.964 35.5536 313.36 36.4327 309.896C36.986 307.716 40.7713 303.676 41.3662 301.593C42.7057 296.905 40.3864 292.195 40.3529 290.758C40.1849 283.508 41.0956 274.241 42.361 268.526C43.8718 261.705 42.8638 256.112 42.361 240.576C42.1776 234.883 43.8671 231.287 43.3654 218.623C42.9391 207.873 47.4172 176.287 47.0897 165.401C47.0897 165.401 47.6262 165.562 48.3867 165.577C49.0295 165.59 49.6836 165.401 49.6836 165.401C49.3551 176.287 53.8333 207.873 53.4079 218.623C52.9053 231.287 54.5947 234.883 54.4121 240.576C53.9095 256.112 52.9006 261.705 54.4121 268.526C55.6771 274.241 56.5881 283.508 56.4197 290.758C56.3867 292.195 54.0676 296.905 55.4069 301.593C56.0018 303.676 59.7872 307.716 60.3397 309.896C61.2197 313.36 62.5647 317.964 64.7793 318.997C71.4739 322.122 80.4255 317.313 76.6062 313.196C74.8499 311.306 69.8918 305.879 68.3031 300.968C68.3031 300.968 67.8917 298.315 67.2339 296.236C65.263 290.008 70.8367 262.183 70.9807 256.949C71.1821 249.605 71.9012 241.497 71.9012 232.85C71.9012 227.487 71.4833 213.882 71.4833 213.882C72.8217 207.298 76.6156 190.673 76.6156 190.673C79.3959 175.716 76.0255 163.452 74.384 149.166C73.2179 139.021 72.3323 135.867 72.2184 128.953C71.9492 112.406 73.1389 86.8741 73.5003 79.6157C73.5097 78.8044 73.5417 78.1239 73.6029 77.6176C73.6029 77.6176 73.5643 78.3413 73.5003 79.6157C72.4311 107.222 76.5036 115.192 76.5036 115.192C75.8344 124.564 77.9549 130.06 77.9549 130.06L84.2044 160.268L85.2255 168.566C80.4424 176.979 84.0726 188.028 84.0726 188.028C85.5568 192.152 88.0312 190.835 88.0312 190.835L87.3705 187.039C86.7098 184.235 87.699 179.949 87.699 179.949L91.1635 187.039L90.0105 197.432C89.186 201.556 92.1536 198.421 92.1536 198.421C95.9475 191.658 96.7729 186.05 96.7729 186.05L93.971 166.586Z",
    heart: "M48.7295 97.5102L47.2795 96.2102C45.5962 94.6935 44.2045 93.3852 43.1045 92.2852C42.0045 91.1852 41.1295 90.1977 40.4795 89.3227C39.8295 88.4477 39.3753 87.6435 39.117 86.9102C38.8587 86.1768 38.7295 85.4268 38.7295 84.6602C38.7295 83.0935 39.2545 81.7852 40.3045 80.7352C41.3545 79.6852 42.6628 79.1602 44.2295 79.1602C45.0962 79.1602 45.9212 79.3435 46.7045 79.7102C47.4878 80.0768 48.1628 80.5935 48.7295 81.2602C49.2962 80.5935 49.9712 80.0768 50.7545 79.7102C51.5378 79.3435 52.3628 79.1602 53.2295 79.1602C54.7962 79.1602 56.1045 79.6852 57.1545 80.7352C58.2045 81.7852 58.7295 83.0935 58.7295 84.6602C58.7295 85.4268 58.6003 86.1768 58.342 86.9102C58.0837 87.6435 57.6295 88.4477 56.9795 89.3227C56.3295 90.1977 55.4545 91.1852 54.3545 92.2852C53.2545 93.3852 51.8628 94.6935 50.1795 96.2102L48.7295 97.5102Z"
  },
  female: {
    width: 86,
    height: 312,
    body: "M83.1254 162.199V152.694C83.0134 142.423 81.228 118.059 81.228 118.059C79.3315 113.141 78.9974 104.838 78.9974 104.838C79.5555 85.6086 77.323 62.4452 77.323 62.4452C75.7616 52.9402 67.5036 52.3933 67.5036 52.3933C62.4824 51.9566 49.6512 46.0563 49.6512 46.0563C47.9778 43.8709 48.5359 36.988 48.5359 36.988C50.6555 34.2558 52.7139 32.1531 52.7139 32.1531L56.3459 31.1969C58.2424 30.2143 63.7662 29.6665 63.7662 29.6665C63.7662 29.6665 61.0518 17.4622 59.8057 12.9511C55.3416 -3.22031 42.5105 0.33078 42.5105 0.33078C42.5105 0.33078 30.2233 -3.34268 25.4393 14.0438C24.1979 18.5558 21.2557 29.6665 21.2557 29.6665C21.2557 29.6665 26.7795 30.2143 28.676 31.1969L32.308 32.1531C32.308 32.1531 34.3664 34.2558 36.4859 36.988C36.4859 36.988 37.0441 43.8709 35.3707 46.0563C35.3707 46.0563 22.5395 51.9566 17.5183 52.3933C17.5183 52.3933 9.26032 52.9402 7.69889 62.4452C7.69889 62.4452 5.46734 85.6086 6.02546 104.838C6.02546 104.838 5.69041 113.141 3.79486 118.059C3.79486 118.059 2.00848 142.423 1.89648 152.694V162.199L0 175.092C0 175.092 0.558119 178.807 3.12567 183.287C3.12567 183.287 5.13135 185.362 4.57416 182.632L3.79486 175.748L6.13746 171.049C6.13746 171.049 6.80759 173.889 6.35959 175.748L5.91253 178.261C5.91253 178.261 7.58689 179.134 8.59113 176.404C8.59113 176.404 11.0457 169.082 7.81183 163.51L12.9422 128.437C12.9422 128.437 16.7361 113.469 16.067 104.291C16.067 104.291 17.9644 82.5489 17.2952 77.0862C17.2952 77.0862 31.2417 107.678 22.8745 120.353C19.1192 126.039 16.7531 134.589 15.3987 144.499C14.1799 153.414 16.1874 168.205 18.9677 182.849C18.9677 182.849 22.2054 202.079 23.5437 208.525C23.5437 208.525 25.4393 223.272 25.4393 228.52C25.4393 236.987 23.8995 244.875 24.1009 252.065C24.2449 257.189 26.6308 268.229 27.4477 273.699C27.8685 276.506 28.3729 284.423 28.8369 287.655H28.836C28.9329 289.534 29.2351 292.947 29.2351 292.947C29.22 293.001 28.9075 295.708 28.6694 296.449C28.2572 297.722 27.9993 299.346 27.9993 299.346C27.0073 302.354 23.9061 305.677 22.8087 306.835C20.419 309.355 26.0162 312.3 30.2045 310.389C31.5899 309.754 32.4294 306.937 32.9791 304.813C33.3254 303.479 35.6935 301.004 36.0643 299.729C36.6299 297.793 36.1556 295.865 35.7801 294.536C35.6285 291.907 35.5448 287.702 35.5438 287.658C35.5288 280.559 36.4859 264.028 36.4859 264.028C36.4859 264.028 38.661 255.671 36.4859 236.66C35.8516 231.116 38.9961 226.826 38.4944 214.427C38.0671 203.899 42.6507 166.432 40.7533 155.942L42.5105 155.944L44.2677 155.942C42.3712 166.432 46.9538 203.899 46.5284 214.427C46.0258 226.826 49.1703 231.116 48.5359 236.66C46.3608 255.671 48.5359 264.028 48.5359 264.028C48.5359 264.028 49.4931 280.559 49.479 287.658C49.4781 287.697 49.4093 291.085 49.286 293.681C48.9896 294.881 48.0117 297.363 48.7345 299.841C49.1063 301.114 51.4743 303.591 51.8207 304.925C52.3703 307.047 53.2108 309.866 54.5953 310.499C58.7836 312.412 64.3808 309.467 61.992 306.947C60.8946 305.787 57.7934 302.466 56.8005 299.458C56.8005 299.458 56.5435 297.833 56.1303 296.561C55.9421 295.974 55.7275 294.908 55.7332 293.795C55.7059 293.228 56.0889 289.534 56.1859 287.655H56.1849C56.6499 284.423 57.1544 276.506 57.5741 273.699C58.3911 268.229 60.777 257.189 60.9219 252.065C61.1224 244.875 59.5826 236.987 59.5826 228.52C59.5826 223.272 61.4781 208.525 61.4781 208.525C62.8165 202.079 66.0551 182.849 66.0551 182.849C68.8345 168.205 70.8429 153.414 69.6241 144.499C68.2697 134.589 65.9036 126.039 62.1473 120.353C53.7812 107.678 67.7267 77.0862 67.7267 77.0862C67.0575 82.5489 68.9549 104.291 68.9549 104.291C68.2857 113.469 72.0797 128.437 72.0797 128.437L77.2101 163.51C73.9762 169.082 76.4317 176.404 76.4317 176.404C77.4359 179.134 79.1094 178.261 79.1094 178.261L78.6614 175.748C78.2152 173.889 78.8844 171.049 78.8844 171.049L81.228 175.748L80.4487 182.632C79.8896 185.362 81.8971 183.287 81.8971 183.287C84.4637 178.807 85.0219 175.092 85.0219 175.092L83.1254 162.199Z",
    heart: "M42.8457 97.5692L41.3957 96.2692C39.7124 94.7526 38.3207 93.4442 37.2207 92.3442C36.1207 91.2442 35.2457 90.2567 34.5957 89.3817C33.9457 88.5067 33.4915 87.7026 33.2332 86.9692C32.9749 86.2359 32.8457 85.4859 32.8457 84.7192C32.8457 83.1526 33.3707 81.8442 34.4207 80.7942C35.4707 79.7442 36.779 79.2192 38.3457 79.2192C39.2124 79.2192 40.0374 79.4026 40.8207 79.7692C41.604 80.1359 42.279 80.6526 42.8457 81.3192C43.4124 80.6526 44.0874 80.1359 44.8707 79.7692C45.654 79.4026 46.479 79.2192 47.3457 79.2192C48.9124 79.2192 50.2207 79.7442 51.2707 80.7942C52.3207 81.8442 52.8457 83.1526 52.8457 84.7192C52.8457 85.4859 52.7165 86.2359 52.4582 86.9692C52.1999 87.7026 51.7457 88.5067 51.0957 89.3817C50.4457 90.2567 49.5707 91.2442 48.4707 92.3442C47.3707 93.4442 45.979 94.7526 44.2957 96.2692L42.8457 97.5692Z"
  }
};
var Silhouette = ({
  gender = "male",
...
var Pill = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  justify-content: center;
  padding: ${({ theme: theme2 }) => theme2.padding.xs}px;
  ...
  min-width: 40px;
`;
var Triangle = styled40__default.default(reactNative.View)`
  position: absolute;
  top: -9px;
  left: 50%;
  width: 0;
...
var Pill2 = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  justify-content: center;
  padding: ${({ theme: theme2 }) => theme2.padding.xs}px;
...
var ChartFrame = styled40__default.default(reactNative.View)`
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.m}px;
  background-color: ${({ theme: theme2 }) => theme2.surface.medium};
`;
var Layer = styled40__default.default(reactNative.View)`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
  bottom: 0;
`;
var KcalAnchor = styled40__default.default(reactNative.View)`
  position: absolute;
  width: 0;
  align-items: center;
`;
var TimeAnchor = styled40__default.default(reactNative.View)`
  position: absolute;
  width: 0;
  align-items: center;
`;

// src/components/LineCaloriesChart/LineCaloriesChart.utils.ts
        ...
        children: [
          ...
          laid.map((p) => /* @__PURE__ */ jsxRuntime.jsx(
            KcalAnchor,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(CaloriesTag, { value: p.kcal, unit })
            },
            `k-${p.index}`
          )),
          laid.map((p) => /* @__PURE__ */ jsxRuntime.jsx(
            TimeAnchor,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(TimeStamp, { time: p.time })
            },
            `t-${p.index}`
          ))
        ]
...
var Row6 = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
`;
var SideLabel = styled40__default.default.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  color: ${({ $active, $disabled, theme: theme2 }) => $disabled ? theme2.content.disable : $active ? theme2.content.dark : theme2.content.medium};
`;
var Track2 = styled40__default.default(reactNative.Pressable)`
  width: 32px;
  height: 16px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.pill}px;
  background-color: ${({ theme: theme2 }) => theme2.surface.high};
  ...
  opacity: ${({ $disabled }) => $disabled ? 0.5 : 1};
`;
var Thumb = styled40__default.default(reactNative.View)`
  width: 16px;
  height: 16px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.pill}px;
  ...
  ({
    ...
    const track = /* @__PURE__ */ jsxRuntime.jsx(
      Track2,
      {
        ...
        testID,
        children: /* @__PURE__ */ jsxRuntime.jsx(Thumb, { $on: value })
      }
    );
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(Row6, { ref, children: [
      ...
      track,
      rightLabel ? /* @__PURE__ */ jsxRuntime.jsx(SideLabel, { $active: value, $disabled: disabled, children: rightLabel }) : null
    ] });
  }
);
Toggle.displayName = "Toggle";

// src/icons/raw/sunny.png
var sunny_default = "./sunny-LG2TWWWX.png";

// src/icons/raw/rainy.png
var rainy_default = "./rainy-XY2B4BD3.png";
...
var Row7 = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
`;
var TimePill = styled40__default.default(reactNative.View)`
  padding-horizontal: ${({ theme: theme2 }) => theme2.padding.s}px;
  padding-vertical: ${({ theme: theme2 }) => theme2.padding.xs}px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.s}px;
  background-color: ${({ theme: theme2 }) => theme2.surface.standard};
`;
var TimeText2 = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.s}px;
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
`;
var Label10 = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      Row7,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(Label10, { children: label })
        ]
      }
    );
  }
...
var Stack = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-items: flex-start;
  gap: ${({ theme: theme2 }) => theme2.gap.l}px;
`;
var IconRow = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  justify-content: center;
  align-self: stretch;
  ...
  ({ condition, isNight, time, label, accessibilityLabel, testID }, ref) => {
    return /* @__PURE__ */ jsxRuntime.jsxs(
      Stack,
      {
        ...
        testID,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(IconRow, { children: /* @__PURE__ */ jsxRuntime.jsx(WeatherIcon, { condition, isNight, size: "l" }) }),
          /* @__PURE__ */ jsxRuntime.jsx(WeatherEventChip, { time, label })
        ]
      }
    );
  }
...
var Stack2 = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: flex-start;
`;
var Pole = styled40__default.default(reactNative.View)`
  width: 3px;
  height: ${({ $height }) => $height}px;
  background-color: ${({ theme: theme2 }) => theme2.content.dark};
`;
var Flag = styled40__default.default(reactNative.View)`
  width: 80px;
  height: 30px;
  background-color: ${({ theme: theme2 }) => theme2.content.dark};
  align-items: center;
...
`;
var FlagText = styled40__default.default.Text`
...
var Container18 = styled40__default.default(reactNative.View)`
  align-items: center;
  justify-content: center;
  padding-horizontal: ${({ theme: theme2 }) => theme2.padding.m}px;
  padding-vertical: ${({ theme: theme2 }) => theme2.padding.s}px;
...
`;
var Label11 = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.light};
  font-family: ${typography.badge.s.fontFamily};
  font-size: ${typography.badge.s.fontSize}px;
  font-weight: ${typography.badge.s.fontWeight};
  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      Container18,
      {
        ...
        accessibilityLabel: accessibilityLabel ?? text,
        testID,
        children: /* @__PURE__ */ jsxRuntime.jsx(Label11, { numberOfLines: 1, children: text })
      }
    );
  }
);
StatusTag.displayName = "StatusTag";
var Card5 = styled40__default.default(reactNative.Pressable)`
  flex-direction: column;
  align-items: flex-start;
  gap: 10px;
  padding: ${({ theme: theme2 }) => theme2.padding.m}px;
  ...
  overflow: hidden;
`;
var Title3 = styled40__default.default.Text`
  align-self: stretch;
  color: ${({ theme: theme2 }) => theme2.content.primary};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.title};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
...
`;
var Section = styled40__default.default(reactNative.View)`
  align-self: stretch;
  flex-direction: column;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var SectionHeading = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${typography.badge.s.fontFamily};
  font-weight: ${typography.badge.s.fontWeight};
  font-size: ${typography.badge.s.fontSize}px;
`;
var SectionBody = styled40__default.default.Text`
  align-self: stretch;
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var FooterRow = styled40__default.default(reactNative.View)`
  align-self: stretch;
  flex-direction: row;
  align-items: center;
  justify-content: space-between;
`;
var AuthorBlock = styled40__default.default(reactNative.View)`
  flex: 1;
  min-width: 0;
  flex-direction: column;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var AuthorRow = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var AuthorName = styled40__default.default.Text`
  flex: 0 1 auto;
  max-width: 80px;
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${typography.badge.s.fontFamily};
  ...
  font-size: ${typography.badge.s.fontSize}px;
`;
var LocationLabel = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.secondary};
  font-family: ${typography.badge.s.fontFamily};
  font-weight: ${typography.badge.s.fontWeight};
  font-size: ${typography.badge.s.fontSize}px;
...
var ReportCard = React12.forwardRef(
  ({
    ...
    summaryLabel = "Resumo",
    creationDate,
    creationDateLabel = "Data de cria\xE7\xE3o",
    author,
    authorLabel = "Autor",
    location,
    responsibles,
    responsiblesLabel = "Respons\xE1veis",
    onPress,
    fullWidth = false,
    accessibilityLabel,
    testID
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      Card5,
      {
        ...
        accessibilityLabel: accessibilityLabel ?? title,
        testID,
        style: fullWidth ? { alignSelf: "stretch", width: "100%" } : { alignSelf: "flex-start", width: 270 },
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(StatusTag, { status, label: statusLabel }),
          /* @__PURE__ */ jsxRuntime.jsx(Title3, { children: title }),
          /* @__PURE__ */ jsxRuntime.jsxs(Section, { children: [
            /* @__PURE__ */ jsxRuntime.jsx(SectionHeading, { children: summaryLabel }),
            /* @__PURE__ */ jsxRuntime.jsx(SectionBody, { children: summary })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsxs(Section, { children: [
            /* @__PURE__ */ jsxRuntime.jsx(SectionHeading, { children: creationDateLabel }),
            /* @__PURE__ */ jsxRuntime.jsx(SectionBody, { children: creationDate })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsxs(FooterRow, { children: [
            /* @__PURE__ */ jsxRuntime.jsxs(AuthorBlock, { children: [
          ...
          responsibles ? /* @__PURE__ */ jsxRuntime.jsxs(Section, { children: [
            /* @__PURE__ */ jsxRuntime.jsx(SectionHeading, { children: responsiblesLabel }),
            /* @__PURE__ */ jsxRuntime.jsx(SectionBody, { numberOfLines: 1, children: responsibles })
          ] }) : null
        ]
      }
    );
...
var Container19 = styled40__default.default(reactNative.View)`
  flex-direction: column;
  position: relative;
`;
var RulerRow = styled40__default.default(reactNative.View)`
  position: absolute;
  top: 64px;
  left: 0;
  right: 0;
  ...
  z-index: 1;
`;
var RulerLine = styled40__default.default(reactNative.View)`
  width: 1px;
  height: ${({ $major }) => $major ? 20 : 12}px;
  background-color: ${({ theme: theme2 }) => theme2.content.dark};
  opacity: 0.4;
`;
var EventsRow = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: flex-start;
  justify-content: space-between;
`;
var EventColumn = styled40__default.default(reactNative.View)`
  flex: 1;
  min-width: 200px;
  align-items: flex-start;
  position: relative;
...
styled40__default.default(reactNative.View)`
  ...
  position: relative;
`;
var NowFloat = styled40__default.default(reactNative.View)`
  position: absolute;
  top: 40px;
  z-index: 2;
`;
var IntensityRow = styled40__default.default(reactNative.View)`
  flex-direction: row;
  height: 12px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.pill}px;
  overflow: hidden;
...
`;
var IntensitySegmentView = styled40__default.default(reactNative.View)`
  flex: ${({ $flex }) => $flex};
  background-color: ${({ $bg }) => $bg};
`;
var ScrollTrack = styled40__default.default(reactNative.View)`
  height: 8px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.l}px;
  background-color: ${({ theme: theme2 }) => theme2.surface.medium};
  ...
  flex-direction: row;
`;
var ScrollThumb = styled40__default.default(reactNative.View)`
  height: 8px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.l}px;
  background-color: ${({ theme: theme2 }) => theme2.surface.high};
`;
...
var WeatherTimeline = React12.forwardRef(
  ({
    ...
    const intensityColor = (c) => {
      switch (c) {
        ...
        case "sun":
          return theme2.surface.warning;
        case "mild":
          return theme2.surface.secondaryLight;
        case "cloudy":
          return theme2.surface.success;
        default:
          return c;
    ...
    const fallbackSegments = events.map((e) => ({
      id: e.id,
      flex: 1,
...
var Card6 = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-items: stretch;
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
  padding-horizontal: ${({ theme: theme2 }) => theme2.padding.m}px;
  padding-top: ${({ theme: theme2 }) => theme2.padding.s}px;
  padding-bottom: ${({ theme: theme2 }) => theme2.padding.l}px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.m}px;
  background-color: ${({ theme: theme2 }) => theme2.surface.standard};
`;
var HeaderRow = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
  justify-content: space-between;
`;
var UserInfoCluster = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.xxl}px;
`;
var UserData = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
`;
var UserText = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-items: flex-start;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
  width: 145px;
`;
var NameAge = styled40__default.default(reactNative.View)`
  flex-direction: column;
`;
var NameText = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var AgeText = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var BloodRow = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: 5px;
`;
var BloodText = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.ms}px;
`;
var VerticalDivider = styled40__default.default(reactNative.View)`
  width: 1px;
  height: 56px;
  background-color: ${({ theme: theme2 }) => theme2.content.medium};
`;
var HorizontalDivider = styled40__default.default(reactNative.View)`
  height: 1px;
  align-self: stretch;
  background-color: ${({ theme: theme2 }) => theme2.content.medium};
`;
var RoleStack = styled40__default.default(reactNative.View)`
  flex-direction: column;
  width: 186px;
`;
var RolePrimary = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var RoleSecondary = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var ActionsRow = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
`;
var IconButton2 = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
  justify-content: center;
  padding: ${({ theme: theme2 }) => theme2.padding.sm}px;
  ...
  background-color: ${({ theme: theme2 }) => theme2.surface.high};
`;
var ChevronWrap2 = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-items: center;
  justify-content: center;
  ...
  padding-vertical: ${({ theme: theme2 }) => theme2.padding.sm}px;
`;
var ExpandedRow = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: 51px;
`;
var AlertsList = styled40__default.default(reactNative.View)`
  flex: 1;
  min-width: 0;
  flex-direction: column;
  gap: ${({ theme: theme2 }) => theme2.gap.sm}px;
`;
var AlertItem = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  align-self: stretch;
`;
var AlertContent = styled40__default.default(reactNative.View)`
  flex: 1;
  min-width: 0;
  flex-direction: column;
  gap: 5px;
`;
var AlertTitle = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.ms}px;
`;
var AlertBody = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var ActionsColumn = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-items: flex-start;
  gap: ${({ theme: theme2 }) => theme2.gap.sm}px;
  width: 280px;
`;
var PauseButton = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
  justify-content: center;
  padding: ${({ theme: theme2 }) => theme2.padding.sm}px;
  ...
  align-self: stretch;
`;
var PauseButtonLabel = styled40__default.default.Text`
  color: ${({ theme: theme2 }) => theme2.content.light};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
...
var WorkersInfoCard = React12.forwardRef(
  ({
    ...
    onCallEmployee,
    onSendBreakAlert,
    examHistoryLabel = "Hist\xF3rico de exames cl\xEDnicos",
    callEmployeeLabel = "Ligar para o funcion\xE1rio",
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      Card6,
      {
        ...
        accessibilityLabel: accessibilityLabel ?? employee.name,
        testID,
        style: fullWidth ? { alignSelf: "stretch", width: "100%" } : { alignSelf: "flex-start", width: 877 },
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs(
            HeaderRow,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsxs(UserInfoCluster, { children: [
                  /* @__PURE__ */ jsxRuntime.jsxs(UserData, { children: [
                    /* @__PURE__ */ jsxRuntime.jsx(Avatar, { uri: employee.avatarUri, size: "l", bordered: true }),
                    /* @__PURE__ */ jsxRuntime.jsxs(UserText, { children: [
                      /* @__PURE__ */ jsxRuntime.jsxs(NameAge, { children: [
                        /* @__PURE__ */ jsxRuntime.jsx(NameText, { numberOfLines: 1, children: employee.name }),
                        /* @__PURE__ */ jsxRuntime.jsx(AgeText, { children: `${employee.age} anos` })
                      ] }),
                      /* @__PURE__ */ jsxRuntime.jsxs(BloodRow, { children: [
                        /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: "humidity_mid", size: 20, color: theme2.surface.error }),
                        /* @__PURE__ */ jsxRuntime.jsx(BloodText, { children: employee.bloodType })
                      ] })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntime.jsx(VerticalDivider, {}),
                  /* @__PURE__ */ jsxRuntime.jsxs(RoleStack, { children: [
                    /* @__PURE__ */ jsxRuntime.jsx(RolePrimary, { numberOfLines: 1, children: employee.role }),
                    employee.secondaryRole ? /* @__PURE__ */ jsxRuntime.jsx(RoleSecondary, { numberOfLines: 1, children: employee.secondaryRole }) : null
                  ] }),
                  /* @__PURE__ */ jsxRuntime.jsx(VerticalDivider, {}),
                  /* @__PURE__ */ jsxRuntime.jsx(Toggle, { value: enabled, onChange: onEnabledChange })
                ] }),
                /* @__PURE__ */ jsxRuntime.jsxs(ActionsRow, { children: [
                  onDelete ? /* @__PURE__ */ jsxRuntime.jsx(IconButton2, { onPress: onDelete, accessibilityRole: "button", accessibilityLabel: "Excluir", children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: "delete_icon", size: 24, color: theme2.content.dark }) }) : null,
                  onChat ? /* @__PURE__ */ jsxRuntime.jsx(IconButton2, { onPress: onChat, accessibilityRole: "button", accessibilityLabel: "Mensagem", children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: "chat_bubble", size: 24, color: theme2.content.dark }) }) : null,
                  onLocation ? /* @__PURE__ */ jsxRuntime.jsx(IconButton2, { onPress: onLocation, accessibilityRole: "button", accessibilityLabel: "Localiza\xE7\xE3o", children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: "location_on", size: 24, color: theme2.content.dark }) }) : null
                ] }),
                /* @__PURE__ */ jsxRuntime.jsx(ChevronWrap2, { children: /* @__PURE__ */ jsxRuntime.jsx(
                  Icon,
                  {
          ...
          expanded ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            /* @__PURE__ */ jsxRuntime.jsx(HorizontalDivider, {}),
            /* @__PURE__ */ jsxRuntime.jsxs(ExpandedRow, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(AlertsList, { children: alerts.map((alert, idx) => /* @__PURE__ */ jsxRuntime.jsxs(AlertItem, { children: [
                /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: alert.icon, size: 24, color: theme2.content.dark }),
                /* @__PURE__ */ jsxRuntime.jsxs(AlertContent, { children: [
                  /* @__PURE__ */ jsxRuntime.jsx(AlertTitle, { children: alert.title }),
                  /* @__PURE__ */ jsxRuntime.jsx(AlertBody, { children: alert.description })
                ] })
              ] }, `${alert.title}-${idx}`)) }),
              /* @__PURE__ */ jsxRuntime.jsxs(ActionsColumn, { children: [
                onExamHistory ? /* @__PURE__ */ jsxRuntime.jsx(
                  Button,
                  {
                ...
                onCallEmployee ? /* @__PURE__ */ jsxRuntime.jsx(
                  Button,
                  {
                ...
                onSendBreakAlert ? /* @__PURE__ */ jsxRuntime.jsx(
                  PauseButton,
                  {
                    ...
                    style: elevation.md,
                    children: /* @__PURE__ */ jsxRuntime.jsx(PauseButtonLabel, { children: sendBreakAlertLabel })
                  }
                ) : null
              ] })
            ] })
...
var HEART_STATUS_OFFSET = {
  left: 169.2,
  top: 374 - 208.58 - 26.093,
  // bottom 208.58, height 26.093 → top
  height: 26.093
};
var HEART_RATE_BUTTON = {
  size: 90.03,
  right: 22.45,
  top: 187.04
};
...
var PROGRESS_START_DEG = -90;
var PROGRESS_MAX_SWEEP_DEG = 325.6;
var SECTOR_R = 110;
var polar = (cx, cy, r, deg) => {
  const rad = deg * Math.PI / 180;
  return { x: cx + r * Math.cos(rad), y: cy + r * Math.sin(rad) };
};
var sectorPath = (cx, cy, r, startDeg, sweepDeg) => {
  const sweep = Math.max(sweepDeg, 1e-4);
...
var BUTTON_DROP_SHADOW = reactNative.Platform.select({
  ios: {
    shadowColor: "#000",
  ...
  android: { elevation: 3 },
  web: { boxShadow: "0px 2.178px 2.178px rgba(0,0,0,0.16)" },
  default: {}
});
...
var StatusChart = ({
  ...
  const theme2 = useTheme();
  const p = palette(theme2, condition);
  const silhouetteXml = React12.useMemo(
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: { width: outerW, height: outerH, overflow: "hidden" }, children: /* @__PURE__ */ jsxRuntime.jsx(
    reactNative.View,
    {
      style: {
        width: STATUS_CHART_CANVAS.width,
...
var Dot2 = styled40__default.default(reactNative.View)`
  width: 20px;
  height: 20px;
  border-radius: 10px;
  align-items: center;
...
`;
var Label12 = styled40__default.default.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
...
var Step = ({ state, number, testID, accessibilityLabel }) => /* @__PURE__ */ jsxRuntime.jsx(
  Dot2,
  {
    ...
    children: /* @__PURE__ */ jsxRuntime.jsx(Label12, { $state: state, children: renderContent(state, number) })
  }
);
Step.displayName = "Step";
var Container20 = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  align-self: stretch;
`;
var Connector = styled40__default.default(reactNative.View)`
  flex: 1;
  height: 4px;
  border-radius: 2px;
  background-color: ${({ $reached, theme: theme2 }) => $reached ? theme2.content.primary : theme2.content.medium};
`;
var GradientTrack = styled40__default.default(reactNative.View)`
  flex: 1;
  height: 4px;
  border-radius: 2px;
  overflow: hidden;
...
var Container21 = styled40__default.default(reactNative.Pressable)`
  flex: 1;
  flex-direction: column;
  align-items: center;
  justify-content: center;
  ...
  border-color: ${({ theme: theme2 }) => theme2.content.primary};
`;
var IconSlot7 = styled40__default.default(reactNative.View)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
`;
var Label13 = styled40__default.default.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: 12px;
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    Container21,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(Label13, { $selected: selected, children: label })
      ]
    }
  );
};
GenderSelectionCard.displayName = "GenderSelectionCard";
var Row8 = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  align-self: stretch;
`;
var Container22 = styled40__default.default(reactNative.View)`
  flex-direction: column;
  align-self: stretch;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var Description4 = styled40__default.default.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  color: ${(props) => descriptionColor(props)};
...
var GenderSelector = ({
  ...
  /* @__PURE__ */ jsxRuntime.jsxs(Container22, { testID, accessibilityRole: "radiogroup", children: [
    /* @__PURE__ */ jsxRuntime.jsxs(Row8, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        GenderSelectionCard,
        {
          gender: "female",
    ...
    description ? /* @__PURE__ */ jsxRuntime.jsx(Description4, { $variant: descriptionVariant, children: description }) : null
  ] })
);
GenderSelector.displayName = "GenderSelector";
var Container23 = styled40__default.default(reactNative.View)`
  flex-direction: column;
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
  align-self: stretch;
`;
var SyncRow = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  align-self: stretch;
`;
var SyncCell = styled40__default.default(reactNative.View)`
  flex: 1;
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
  ...
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.xs}px;
`;
var IconSlot8 = styled40__default.default(reactNative.View)`
  width: 56px;
  height: 56px;
  align-items: center;
  justify-content: center;
`;
var Value2 = styled40__default.default.Text`
  flex: 1;
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.title};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: 32px;
...
`;
var Message = styled40__default.default.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: 12px;
  text-align: center;
...
var SmartbandStatus = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Container23, { testID, accessibilityLabel: accessibilityLabel ?? message, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(SyncRow, { children: [
      /* @__PURE__ */ jsxRuntime.jsxs(SyncCell, { children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(Value2, { $active: heartActive, children: heartRate != null ? String(heartRate) : "/" })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs(SyncCell, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(IconSlot8, { children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: "blood_pressure", size: 47, color: pressureColor }) }),
        /* @__PURE__ */ jsxRuntime.jsx(Value2, { $active: pressureActive, children: bloodPressure != null ? bloodPressure : "/" })
      ] })
    ] }),
...
var Container24 = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  ${({ $separated, theme: theme2 }) => $separated ? `gap: ${theme2.gap.s}px;` : ""};
`;
var Tab = styled40__default.default(reactNative.Pressable)`
  align-items: center;
  justify-content: center;
  padding-horizontal: ${({ theme: theme2 }) => theme2.padding.s}px;
  padding-vertical: ${({ theme: theme2 }) => theme2.padding.s}px;
  ...
  opacity: ${({ $disabled }) => $disabled ? 0.5 : 1};
`;
var TabLabel = styled40__default.default.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
        ...
        children: tabs.map((tab, idx) => {
          ...
          return /* @__PURE__ */ jsxRuntime.jsx(
            Tab,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(TabLabel, { $active: isActive, numberOfLines: 1, children: tab.label })
            },
            tab.value
          );
        })
...
var StatusIcon = ({ variant, color }) => /* @__PURE__ */ jsxRuntime.jsx(
  reactNative.View,
  {
    style: {
      width: 24,
    ...
    children: variant === "info" ? (
      ...
      /* @__PURE__ */ jsxRuntime.jsx(Icon, { name: "info", size: 20, color })
    ) : /* @__PURE__ */ jsxRuntime.jsx(
      reactNative.Text,
      {
        style: {
        ...
        children: SYMBOL[variant]
      }
    )
  }
);
var CloseIcon = ({ color }) => /* @__PURE__ */ jsxRuntime.jsxs(
  reactNative.View,
  {
    style: {
      width: 24,
...
var variantBackground = ({
  $variant,
  theme: theme2
}) => {
  switch ($variant) {
    case "error":
      return theme2.surface.errorLight;
    case "success":
      return theme2.surface.successLight;
    case "warning":
      return theme2.surface.warningLight;
    case "info":
      return theme2.surface.infoLight;
  }
};
var Container25 = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  padding: ${({ theme: theme2 }) => theme2.padding.s}px;
...
`;
var MessageContainer = styled40__default.default(reactNative.View)`
  flex: 1;
  flex-direction: column;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var Title4 = styled40__default.default.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  color: ${({ theme: theme2 }) => theme2.content.light};
`;
var Message2 = styled40__default.default.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  color: ${({ theme: theme2 }) => theme2.content.light};
  ...
  ({ variant = "info", title, message, onClose, accessibilityLabel, testID }, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      Container25,
      {
        ...
        testID,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(StatusIcon, { variant, color: theme2.content.light }),
          /* @__PURE__ */ jsxRuntime.jsxs(MessageContainer, { children: [
...
var Container26 = styled40__default.default(reactNative.View)`
  flex-direction: row;
  align-items: center;
  width: 100%;
  padding-top: ${({ theme: theme2 }) => theme2.padding.s}px;
...
`;
var BackSlot = styled40__default.default(reactNative.Pressable)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
  margin-left: -6px;
  ...
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.m}px;
`;
var TitleSlot = styled40__default.default(reactNative.View)`
  flex: 1;
  align-items: flex-end;
`;
var TopBar = React12.forwardRef(
  ({ title, onBack, backLabel = "Voltar", accessibilityLabel, testID }, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(Container26, { ref, testID, children: [
...
exports.ChatUserCard = ChatUserCard;
...
exports.SmartbandStatus = SmartbandStatus;
...
exports.WeatherTimelineEntry = WeatherTimelineEntry;
exports.WorkersInfoCard = WorkersInfoCard;
exports.elevation = elevation;
exports.fontFamily = fontFamily;
exports.fontSize = fontSize;
exports.fontWeight = fontWeight;
exports.isLightBgVariant = isLightBgVariant;
exports.primitive = primitive;
exports.semantic = semantic;
exports.theme = theme;
exports.typography = typography;
exports.useSurfaceTone = useSurfaceTone;
