import styled40, { css, useTheme as useTheme$1, ThemeProvider } from 'styled-components/native';
...
var Icon = ({
  ...
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      children: [
        gradient ? /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("linearGradient", { id: gradId, x1: "0", y1: "0", x2: "0", y2: "1", children: [
          /* @__PURE__ */ jsx("stop", { offset: "0", stopColor: gradient[0] }),
          /* @__PURE__ */ jsx("stop", { offset: "1", stopColor: gradient[1] })
        ] }) }) : null,
        /* @__PURE__ */ jsx("path", { d: icon.d, fill, fillRule: icon.fillRule ?? "nonzero" })
      ]
    }
  );
};
var Container = styled40(View)`
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.s}px;
  overflow: hidden;
`;
var Header = styled40(Pressable)`
  flex-direction: row;
  align-items: center;
        ...
        children: [
          /* @__PURE__ */ jsxs(
            Header,
            {
              ...
              children: [
                showIconLeft ? /* @__PURE__ */ jsx(ChevronWrap, { $open: open, children: /* @__PURE__ */ jsx(Icon, { name: "keyboard_arrow_down", size: 16, color: chevronColor }) }) : null,
                /* @__PURE__ */ jsx(TitleText, { numberOfLines: 1, children: title }),
                showIconRight ? /* @__PURE__ */ jsx(ChevronWrap, { $open: open, children: /* @__PURE__ */ jsx(Icon, { name: "keyboard_arrow_down", size: 16, color: chevronColor }) }) : null
              ]
            }
          ),
          open && children !== void 0 ? /* @__PURE__ */ jsx(Content, { children: typeof children === "string" ? /* @__PURE__ */ jsx(ContentText, { children }) : children }) : null
        ]
      }
    );
  }
...
var Row = styled40(View)`
  flex-direction: row;
  align-items: center;
`;
var AvatarSlot = styled40(View)`
  margin-left: ${({ $marginLeft }) => $marginLeft}px;
`;
var CountBadge = styled40(View)`
  width: ${({ $size }) => $size}px;
  height: ${({ $size }) => $size}px;
  margin-left: ${({ $marginLeft }) => $marginLeft}px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.pill}px;
...
var AvatarGroup = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs(Row, { ref, accessibilityLabel, testID, children: [
      visibleAvatars.map((item, idx) => /* @__PURE__ */ jsx(AvatarSlot, { $marginLeft: idx === 0 ? 0 : overlap, children: /* @__PURE__ */ jsx(
        Avatar,
        {
          uri: item.uri,
          size,
      ...
      remaining > 0 ? /* @__PURE__ */ jsx(
        CountBadge,
        {
          ...
          children: /* @__PURE__ */ jsx(CountText, { children: `+${remaining}` })
        }
      ) : null
    ] });
  }
...
`;
var CardPressable = styled40(Pressable)`
  flex-grow: 1;
  flex-shrink: 1;
  flex-direction: row;
  align-items: center;
  ...
  min-width: 0;
`;
var LeftContent = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.l}px;
  flex-shrink: 1;
`;
var IconSlot = styled40(View)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
`;
var Divider = styled40(View)`
  align-self: stretch;
  width: 1px;
  background-color: ${({ theme: theme2 }) => theme2.content.dark};
  opacity: 0.2;
`;
var InfoColumn = styled40(View)`
  flex-direction: column;
  align-items: flex-start;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
  flex-shrink: 1;
`;
var Title = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var Subtitle = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var ProgressSlot = styled40(View)`
  width: 119px;
  margin-top: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var RightContent = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
`;
var LocationButton = styled40(Pressable)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
`;
var ActivitiesOverviewCard = forwardRef(
  ({
    title,
    subtitle,
    progress,
...
var BackgroundDotsGrid = memo(function BackgroundDotsGrid2({
  ...
  return /* @__PURE__ */ jsx(
    View,
    {
      ...
      pointerEvents: "none",
      testID,
      children: /* @__PURE__ */ jsx("svg", { width: "100%", height: "100%", viewBox, xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsx("path", { d: pathData, fill: color }) })
    }
  );
});
BackgroundDotsGrid.displayName = "BackgroundDotsGrid";
var Card2 = styled40(View)`
  flex-direction: column;
  ...
  background-color: ${({ theme: theme2 }) => theme2.surface.standard};
`;
var IconSlot2 = styled40(View)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
`;
var Value = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.title};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  ...
  text-align: center;
`;
var Label = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
`;
var BigNumbersCard = forwardRef(
  ({
    value,
    label,
    icon,
    ...
    return /* @__PURE__ */ jsxs(
      Card2,
      {
        ...
        children: [
          icon ? /* @__PURE__ */ jsx(IconSlot2, { children: /* @__PURE__ */ jsx(Icon, { name: icon, size: 20, color: iconColor ?? theme2.content.primary }) }) : null,
          /* @__PURE__ */ jsx(Value, { numberOfLines: 1, children: value }),
          /* @__PURE__ */ jsx(Label, { numberOfLines: 1, children: label })
        ]
      }
    );
  }
...
var Container2 = styled40(Pressable)`
  flex-direction: row;
  align-items: center;
  justify-content: center;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
...
`;
var HoverOverlay = styled40(View)`
  position: absolute;
  inset: 0;
  border-radius: ${({ $shape, theme: theme2 }) => radius($shape, theme2)}px;
  ...
  pointer-events: none;
`;
var PressedOverlay = styled40(View)`
  position: absolute;
  inset: 0;
  border-radius: ${({ $shape, theme: theme2 }) => radius($shape, theme2)}px;
  pointer-events: none;
...
var Row2 = styled40(View)`
  flex-direction: row;
  align-items: flex-end;
  gap: ${({ theme: theme2 }) => theme2.gap.sm}px;
`;
var Bubble = styled40(View)`
  flex: 1;
  min-width: 0;
  flex-direction: column;
  background-color: ${({ theme: theme2 }) => theme2.surface.standard};
...
`;
var BubbleInner = styled40(View)`
  flex-direction: column;
  gap: 10px;
  align-items: ${({ $position }) => $position === "left" ? "flex-end" : "flex-start"};
`;
var TopRow = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  width: 100%;
`;
var MessageText = styled40.Text`
  flex: 1;
  min-width: 0;
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
...
`;
var MenuButton = styled40(Pressable)`
  width: 16px;
  height: 16px;
  align-items: center;
  justify-content: center;
`;
var TimeText = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.s}px;
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
...
var ChatBubble = forwardRef(
  ({
    ...
    const avatar = avatarUri ? /* @__PURE__ */ jsx(Avatar, { uri: avatarUri, size: "m" }) : null;
    const menu = onMenuPress ? /* @__PURE__ */ jsx(
      MenuButton,
      {
        onPress: onMenuPress,
        accessibilityRole: "button",
        accessibilityLabel: "Mensagem op\xE7\xF5es",
        children: /* @__PURE__ */ jsx(Icon, { name: "more_vert", size: 16, color: theme2.content.dark })
      }
    ) : null;
    return /* @__PURE__ */ jsxs(
      Row2,
      {
        ...
        children: [
          !isLeft ? avatar : null,
          /* @__PURE__ */ jsx(Bubble, { $position: position, style: elevation.md, children: /* @__PURE__ */ jsxs(BubbleInner, { $position: position, children: [
            /* @__PURE__ */ jsx(TopRow, { children: !isLeft ? /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(MessageText, { $position: position, children: message }),
              menu
            ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
              menu,
              /* @__PURE__ */ jsx(MessageText, { $position: position, children: message })
            ] }) }),
            /* @__PURE__ */ jsx(TimeText, { children: time })
          ] }) }),
          isLeft ? avatar : null
        ]
      }
...
var Container3 = styled40(Pressable)`
  height: 60px;
  flex-direction: row;
  align-items: center;
  justify-content: space-between;
...
var AvatarRow = styled40(View)`
  ...
  min-width: 0;
`;
var TextStack = styled40(View)`
  flex: 1;
  min-width: 0;
`;
var Name = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs(
      Container3,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs(AvatarRow, { children: [
            avatarUri ? /* @__PURE__ */ jsx(Avatar, { uri: avatarUri, size: "m" }) : null,
            /* @__PURE__ */ jsxs(TextStack, { children: [
              /* @__PURE__ */ jsx(Name, { numberOfLines: 1, children: name }),
...
var Container4 = styled40(View)`
  flex-direction: column;
  align-self: stretch;
`;
var Row3 = styled40(Pressable)`
  flex-direction: row;
  align-items: center;
  justify-content: space-between;
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
  ...
  ${({ $disabled, theme: theme2 }) => $disabled ? css`
        ...
        ` : ""};
`;
var HoverOverlay2 = styled40(View)`
  position: absolute;
  inset: 0;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.m}px;
  background-color: ${({ theme: theme2 }) => theme2.surface.hover};
...
styled40(View)`
  ...
  pointer-events: none;
`;
var StyledInput = styled40(TextInput)`
  flex: 1;
  min-width: 0;
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  ...
  outline-style: none;
`;
var IconSlot4 = styled40(View)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
`;
var IconButton = styled40(Pressable)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
...
var SearchInput = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx(Container4, { children: /* @__PURE__ */ jsxs(
      Row3,
      {
        $focused: focused,
        $hovered: hovered,
        ...
        children: [
          ...
          showClose ? /* @__PURE__ */ jsx(
            IconButton,
            {
              ...
              children: /* @__PURE__ */ jsx(Icon, { name: "close", size: 24, color: iconColor })
            }
          ) : /* @__PURE__ */ jsx(IconSlot4, { children: /* @__PURE__ */ jsx(Icon, { name: "search", size: 24, color: iconColor }) }),
          hovered && !focused && !disabled ? /* @__PURE__ */ jsx(HoverOverlay2, {}) : null
        ]
      }
    ) });
  }
...
`;
var ListScroll = styled40(ScrollView)`
  align-self: stretch;
  max-height: 296px;
    ...
    return /* @__PURE__ */ jsxs(
      Container5,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(ListScroll, { children: /* @__PURE__ */ jsx(ListInner, { children: users.map((user) => {
...
var DonutArc = ({
  ...
  return /* @__PURE__ */ jsxs("svg", { width: size, height: size, viewBox: `0 0 ${size} ${size}`, children: [
    /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("linearGradient", { id: arcId, x1: "0.5", y1: "0", x2: "0.5", y2: "1", children: [
      /* @__PURE__ */ jsx("stop", { offset: "0%", stopColor: arcFrom }),
      /* @__PURE__ */ jsx("stop", { offset: "100%", stopColor: arcTo })
    ] }) }),
    isFlat ? (
      ...
      /* @__PURE__ */ jsx("circle", { cx, cy, r: arcR - arcStroke / 2, fill: "#1a1a1a" })
    ) : /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("circle", { cx, cy, r: outerR, fill: BEZEL_FILL }),
      /* @__PURE__ */ jsx("circle", { cx, cy, r: innerR, fill: WELL_FILL })
    ] }),
    /* @__PURE__ */ jsx(
      "circle",
      {
...
`;
var DonutWrapper = styled40(View)`
  width: ${({ $size }) => $size}px;
  height: ${({ $size }) => $size}px;
  align-items: center;
  justify-content: center;
...
var Caption = styled40.Text`
  ...
  text-align: center;
`;
var LocationButton2 = styled40(Pressable)`
  position: absolute;
  top: 0;
  right: 0;
  width: ${({ $size }) => $size}px;
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs(
      Container6,
      {
        ...
        testID,
        children: [
          /* @__PURE__ */ jsx(TitleText2, { $size: dims.titleSize, $align: titleAlign, numberOfLines: 1, children: title }),
          /* @__PURE__ */ jsxs(DonutWrapper, { $size: dims.outer, children: [
            onLocationPress ? /* @__PURE__ */ jsx(
              LocationButton2,
              {
                ...
                children: /* @__PURE__ */ jsx(Icon, { name: locationIcon, size: 20, color: theme2.content.dark })
              }
            ) : null,
            /* @__PURE__ */ jsx(ArcSlot, { children: /* @__PURE__ */ jsx(
              DonutArc,
              {
                size: dims.outer,
            ...
            /* @__PURE__ */ jsxs(Center, { children: [
              ...
              /* @__PURE__ */ jsx(ValueText, { $size: dims.valueSize, children: value }),
              /* @__PURE__ */ jsx(LabelText, { $size: labelSize, $weight: labelWeight, children: label })
            ] })
          ] }),
...
var UserInfo = styled40(View)`
  ...
  min-width: 0;
`;
var TextStack2 = styled40(View)`
  flex-direction: column;
  align-items: flex-start;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var Name2 = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var Sector = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var ProgressSlot2 = styled40(View)`
  width: 119px;
`;
var Divider2 = styled40(View)`
  width: 1px;
  align-self: stretch;
  background-color: ${({ theme: theme2 }) => theme2.content.medium};
`;
var HealthOverview = styled40(View)`
  flex-direction: column;
  align-items: flex-start;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  ...
  width: 110px;
`;
var Stat = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.sm}px;
`;
var StatText = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
  ...
  white-space: nowrap;
`;
var LocationButton3 = styled40(Pressable)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
`;
var EmployeeOverviewCard = forwardRef(
  ({
    employee,
    progress = 0,
    bpm,
    ...
    return /* @__PURE__ */ jsxs(
      Card3,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs(LeftCluster, { children: [
            /* @__PURE__ */ jsxs(UserInfo, { children: [
              /* @__PURE__ */ jsx(Avatar, { uri: employee.avatarUri, customSize: 56, bordered: true }),
              /* @__PURE__ */ jsxs(TextStack2, { children: [
                /* @__PURE__ */ jsx(Name2, { children: employee.name }),
                /* @__PURE__ */ jsx(Sector, { children: employee.sector }),
                /* @__PURE__ */ jsx(ProgressSlot2, { children: /* @__PURE__ */ jsx(ProgressBar, { value: progress, color: theme2.surface.info }) })
              ] })
            ] }),
            /* @__PURE__ */ jsx(Divider2, {}),
            /* @__PURE__ */ jsxs(HealthOverview, { children: [
              /* @__PURE__ */ jsxs(Stat, { children: [
                /* @__PURE__ */ jsx(Icon, { name: "favorite_filled", size: 24, color: theme2.surface.error }),
                /* @__PURE__ */ jsx(StatText, { children: `${bpm} ${bpmUnit}` })
              ] }),
              /* @__PURE__ */ jsxs(Stat, { children: [
                /* @__PURE__ */ jsx(Icon, { name: "pressure_wheel_filled", size: 24, color: theme2.surface.primary }),
                /* @__PURE__ */ jsx(StatText, { children: pressure })
              ] })
            ] })
          ] }),
          actionElement ?? /* @__PURE__ */ jsx(
            LocationButton3,
            {
              ...
              children: /* @__PURE__ */ jsx(Icon, { name: "location_on_filled", size: 24, color: theme2.content.dark })
            }
          )
        ]
      }
...
var DateText = styled40.Text`
  ...
  `}
`;
var ExamLink = styled40(Pressable)`
  ${({ $compact }) => $compact ? `
    flex: 1;
    align-items: flex-start;
    justify-content: center;
  ...
  `}
`;
var ExamLinkText = styled40.Text`
...
`;
var CompactActionButton = styled40(Pressable)`
  ...
  justify-content: center;
`;
var DownloadIconSlot = styled40(View)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
...
var Row4 = styled40(View)`
  flex-direction: row;
  align-items: center;
  align-self: flex-start;
`;
var VitalsCard = styled40(View)`
  flex-direction: column;
  align-items: flex-start;
  justify-content: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  ...
  margin-right: -32px;
`;
var StatsRow = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: 10px;
`;
var StatItem = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var StatText2 = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
`;
var StatValueBold = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
`;
var ProgressSlot3 = styled40(View)`
  width: 138px;
`;
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs(
      Row4,
      {
        ...
        testID,
        children: [
          /* @__PURE__ */ jsxs(VitalsCard, { children: [
            /* @__PURE__ */ jsxs(StatsRow, { children: [
              /* @__PURE__ */ jsxs(StatItem, { children: [
                /* @__PURE__ */ jsx(Icon, { name: heartIconName, size: 20, color: theme2.content.dark }),
                /* @__PURE__ */ jsxs(StatText2, { children: [
                  /* @__PURE__ */ jsxs(StatValueBold, { children: [
                    bpm,
                    " "
                  ] }),
                  bpmUnit
              ...
              /* @__PURE__ */ jsxs(StatItem, { children: [
                /* @__PURE__ */ jsx(Icon, { name: pressureIconName, size: 20, color: theme2.content.dark }),
                /* @__PURE__ */ jsx(StatValueBold, { children: pressure })
              ] })
            ] }),
            /* @__PURE__ */ jsx(ProgressSlot3, { children: /* @__PURE__ */ jsx(ProgressBar, { value: progress }) })
          ] }),
          /* @__PURE__ */ jsx(Avatar, { uri: avatarUri, size: "l", bordered, borderColor: borderColor2 })
        ]
      }
    );
  }
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs(
      Bar,
      {
        ...
        style: fullWidth ? { alignSelf: "stretch", width: "100%" } : { alignSelf: "flex-start" },
        children: [
          /* @__PURE__ */ jsx(Logo, { type: logoType, size: logoSize }),
          /* @__PURE__ */ jsx(
            HeaderUserInfo,
            {
              bpm,
...
var HeartrateStatus = ({
  ...
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      role: "img",
      children: [
        /* @__PURE__ */ jsx("path", { d: data.circle, fill: conditionColor(theme2, condition) }),
        /* @__PURE__ */ jsx("path", { d: data.symbol, fill: theme2.content.dark })
      ]
    }
  );
};
...
var HeartStatus = ({
  ...
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      role: "img",
      children: [
        /* @__PURE__ */ jsx("path", { d: HEART_PATH, fill: theme2.content.dark }),
        /* @__PURE__ */ jsxs("g", { transform: `translate(${HEART_STATUS_BADGE_OFFSET.x} ${HEART_STATUS_BADGE_OFFSET.y})`, children: [
          /* @__PURE__ */ jsx("path", { d: badge.circle, fill: conditionColor(theme2, condition) }),
          /* @__PURE__ */ jsx("path", { d: badge.symbol, fill: theme2.content.dark })
        ] })
      ]
    }
  );
...
var Container7 = styled40(Pressable)`
  flex-direction: row;
  align-items: center;
  width: 100%;
  background-color: ${({ theme: theme2 }) => theme2.surface.standard};
  ...
  opacity: ${({ $disabled }) => $disabled ? 0.5 : 1};
`;
var LeftSlot = styled40(View)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
`;
var LabelSlot = styled40(View)`
  flex: 1;
`;
var RightSlot = styled40(View)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
    ...
    return /* @__PURE__ */ jsxs(
      Container7,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(LabelSlot, { children: /* @__PURE__ */ jsx(Title2, { variant: "title.xs", color: theme2.content.dark, children: label }) }),
...
var Container8 = styled40(Pressable)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  opacity: ${({ $disabled }) => $disabled ? 0.5 : 1};
`;
var Ring = styled40(View)`
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs(
      Container8,
      {
        ...
        testID,
        children: [
          /* @__PURE__ */ jsx(Ring, { $size: size, children: checked ? /* @__PURE__ */ jsx(Dot, { $size: size }) : null }),
          /* @__PURE__ */ jsx(Label3, { children: label })
        ]
      }
    );
  }
...
var Container9 = styled40(View)`
  flex-direction: column;
  align-self: stretch;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var Label4 = styled40.Text`
  ...
  color: ${({ $disabled, theme: theme2 }) => $disabled ? theme2.content.disable : theme2.content.dark};
`;
var Options = styled40(View)`
  flex-direction: row;
  flex-wrap: wrap;
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
`;
var Description = styled40.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
...
var RadioGroup = forwardRef(
  ({
    ...
    Container9,
    {
      ...
      testID,
      children: [
        label ? /* @__PURE__ */ jsx(Label4, { $disabled: disabled, children: label }) : null,
        /* @__PURE__ */ jsx(Options, { children: options.map((option) => /* @__PURE__ */ jsx(
          Radio,
          {
            label: option.label,
...
var Container10 = styled40(Pressable)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  opacity: ${({ $disabled }) => $disabled ? 0.5 : 1};
`;
var Box = styled40(View)`
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs(
      Container10,
      {
        ...
        testID,
        children: [
          /* @__PURE__ */ jsx(Box, { $size: size, children: checked ? /* @__PURE__ */ jsx(Check, { $size: size, children: "\u2713" }) : null }),
          label ? /* @__PURE__ */ jsx(Label5, { $size: size, children: label }) : null
        ]
      }
    );
  }
...
var Row5 = styled40(Pressable)`
  ...
  ${({ $disabled, theme: theme2 }) => $disabled ? css`
        ...
        ` : ""};
`;
var HoverOverlay3 = styled40(View)`
  position: absolute;
  inset: 0;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.m}px;
  background-color: ${({ theme: theme2 }) => theme2.surface.hover};
...
styled40(View)`
  ...
  pointer-events: none;
`;
var StyledInput2 = styled40(TextInput)`
  flex: 1;
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
...
var Input = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs(Container11, { children: [
      label ? /* @__PURE__ */ jsx(Label6, { $disabled: disabled, $weight: labelWeight, children: label }) : null,
      /* @__PURE__ */ jsxs(
        Row5,
        {
          $focused: focused,
          ...
          children: [
            ...
            iconRight ? /* @__PURE__ */ jsx(IconSlot5, { children: iconRight }) : null,
            hovered && !focused && !disabled ? /* @__PURE__ */ jsx(HoverOverlay3, {}) : null
          ]
        }
      ),
...
var Container12 = styled40(View)`
  flex-direction: column;
  align-self: stretch;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var Label7 = styled40.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
  color: ${({ $disabled, theme: theme2 }) => $disabled ? theme2.content.disable : theme2.content.dark};
`;
var Trigger = styled40(Pressable)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
  padding: ${({ theme: theme2 }) => theme2.padding.sm}px;
...
`;
var TriggerLabel = styled40.Text`
  flex: 1;
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
...
`;
var OptionsList = styled40(View)`
  flex-direction: column;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var OptionRow = styled40(Pressable)`
  flex-direction: row;
  align-items: center;
  padding-horizontal: ${({ theme: theme2 }) => theme2.padding.s}px;
...
`;
var OptionLabel = styled40.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
  color: ${({ theme: theme2 }) => theme2.content.dark};
`;
var Description3 = styled40.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  color: ${(props) => descriptionColor(props)};
...
var Combobox = forwardRef(
  ({
    ...
    const renderOptionRow = (option, idx) => /* @__PURE__ */ jsx(
      OptionRow,
      {
        $first: idx === 0,
    ...
    return /* @__PURE__ */ jsxs(Container12, { testID, children: [
      label ? /* @__PURE__ */ jsx(Label7, { $disabled: disabled, children: label }) : null,
      /* @__PURE__ */ jsxs(
        Trigger,
        {
          ref: triggerRef,
          ...
          accessibilityHint,
          children: [
            /* @__PURE__ */ jsx(TriggerLabel, { $placeholder: isPlaceholder, $disabled: disabled, numberOfLines: 1, children: displayText }),
            /* @__PURE__ */ jsx(
              Icon,
              {
        ...
        Modal,
        {
          ...
          children: /* @__PURE__ */ jsx(
            Pressable,
            {
              ...
              children: triggerRect ? /* @__PURE__ */ jsx(
                View,
                {
                  ...
                  children: /* @__PURE__ */ jsx(Panel, { accessibilityRole: "menu", children: shouldVirtualize ? /* @__PURE__ */ jsx(
                    FlatList,
                    {
                      data: options,
                  ...
                  ) : /* @__PURE__ */ jsx(OptionsList, { children: options.map(renderOptionRow) }) })
                }
              ) : null
            }
          )
      ...
      description ? /* @__PURE__ */ jsx(Description3, { $disabled: disabled, $variant: descriptionVariant, children: description }) : null
    ] });
  }
);
...
var Container13 = styled40(Pressable)`
  align-self: flex-start;
`;
var Body = styled40(View)`
  flex-direction: row;
  align-items: center;
  justify-content: center;
  padding-vertical: ${({ theme: theme2 }) => theme2.padding.xs}px;
  ...
  overflow: hidden;
`;
var Label8 = styled40.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  color: ${(props) => textColor(props)};
`;
var HoverOverlay4 = styled40(View)`
  position: absolute;
  inset: 0;
  ...
  ({
    ...
    return /* @__PURE__ */ jsx(
      Container13,
      {
        ...
        accessibilityHint,
        testID,
        children: /* @__PURE__ */ jsxs(Body, { $state: state, $variant: variant, $colorScheme: colorScheme, children: [
          /* @__PURE__ */ jsx(Label8, { $state: state, $variant: variant, $colorScheme: colorScheme, children: label }),
          !isDisabled && (hovered || pressed) ? /* @__PURE__ */ jsx(HoverOverlay4, {}) : null
        ] })
      }
    );
  }
...
var ChipGroup = ({
  ...
  return /* @__PURE__ */ jsx(View, { style: [{ flexDirection: "row", flexWrap: "wrap", gap: 8 }, style], children: options.map((option) => /* @__PURE__ */ jsx(
    Chip,
    {
      label: option,
      variant,
...
var PreviewSlot = styled40(View)`
  ...
  background-color: ${({ theme: theme2 }) => theme2.surface.medium};
`;
var RemoveButton = styled40(Pressable)`
  position: absolute;
  top: 4px;
  right: 4px;
  width: 16px;
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs(
      Container14,
      {
        ...
        testID,
        children: [
          hasValue ? /* @__PURE__ */ jsxs(PreviewSlot, { children: [
            /* @__PURE__ */ jsx(
              Image,
              {
            ...
            onRemove && !disabled ? /* @__PURE__ */ jsx(
              RemoveButton,
              {
                ...
                onPress: onRemove,
                children: /* @__PURE__ */ jsx(Icon, { name: "close", size: 10, color: theme2.content.dark })
              }
            ) : null
          ] }) : /* @__PURE__ */ jsx(ProgressBar, { value: progress ?? 0, disabled }),
          /* @__PURE__ */ jsx(HelperText, { children: helperText }),
          showTakePhoto ? /* @__PURE__ */ jsx(
            Button,
            {
              ...
              onPress: onTakePhoto,
              iconRight: /* @__PURE__ */ jsx(Icon, { name: "add_a_photo", size: 24, color: ctaIconColor }),
          ...
          /* @__PURE__ */ jsx(
            Button,
            {
              ...
              labelColor: ctaLabelColor,
              onPress: onPickFile,
              iconRight: /* @__PURE__ */ jsx(Icon, { name: "cloud_upload", size: 24, color: ctaIconColor }),
...
var ExpandedBar = styled40(View)`
  ...
  align-self: flex-end;
`;
var TitleText3 = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var Divider3 = styled40(View)`
  width: 1px;
  height: 40px;
  background-color: ${({ theme: theme2 }) => theme2.content.medium};
`;
var SearchSlot = styled40(View)`
  width: 284px;
`;
var OptionsRow = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
  padding: ${({ theme: theme2 }) => theme2.padding.sm}px;
`;
var TrailingButton = styled40(Pressable)`
  flex-direction: row;
  align-items: center;
  justify-content: center;
  padding: ${({ theme: theme2 }) => theme2.padding.sm}px;
...
`;
var CollapsedButton = styled40(Pressable)`
  flex-direction: row;
  align-items: center;
  justify-content: center;
  padding: ${({ theme: theme2 }) => theme2.padding.sm}px;
  ...
  ({
    ...
    if (!expanded) {
      return /* @__PURE__ */ jsx(
        CollapsedButton,
        {
          ...
          testID,
          style: elevation.md,
          children: /* @__PURE__ */ jsx(Icon, { name: iconName, size: 24, color: theme2.content.dark })
        }
      );
    }
    const renderCenter = () => {
      if (variant === "heatmap") {
        return /* @__PURE__ */ jsx(OptionsRow, { children: options?.map((opt) => /* @__PURE__ */ jsx(
          Checkbox,
          {
            label: opt.label,
            size: "s",
      ...
      return /* @__PURE__ */ jsx(SearchSlot, { children: /* @__PURE__ */ jsx(
        SearchInput,
        {
          value: searchValue,
          onChangeText: onSearchChange,
    ...
    return /* @__PURE__ */ jsxs(
      ExpandedBar,
      {
        ...
        testID,
        children: [
          /* @__PURE__ */ jsx(TitleText3, { numberOfLines: 1, children: resolvedTitle }),
...
var Container15 = styled40(View)`
  align-items: center;
  justify-content: flex-start;
`;
var TailWrapper = styled40(View)`
  margin-top: -2px;
`;
var CameraBody = styled40(View)`
...
var LocationPin = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs(Container15, { ref, testID, accessibilityLabel: name, children: [
      ...
      ) }) : variant === "badge" ? /* @__PURE__ */ jsx(BadgeBody, { $size: size, $fill: badgeFill, accessibilityLabel: name, children: /* @__PURE__ */ jsx(
        Icon,
        {
...
var Container16 = styled40(Pressable)`
...
`;
var HoverOverlay5 = styled40(View)`
  position: absolute;
  inset: 0;
  border-radius: ${({ $variant, theme: theme2 }) => $variant === "compact" ? "0px" : `${theme2.border.radius.m}px`};
  background-color: ${({ theme: theme2 }) => theme2.surface.hover};
  pointer-events: none;
`;
var LabelGroup = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
`;
var IconSlot6 = styled40(View)`
  width: 22px;
  height: 22px;
  align-items: center;
  justify-content: center;
`;
var Label9 = styled40.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
...
`;
var Divider4 = styled40(View)`
  width: 2px;
  height: 100%;
  border-radius: 2px;
  background-color: ${(props) => dividerColor(props)};
`;
var BadgeOverlay = styled40(View)`
  position: absolute;
  top: 0;
      ...
      Container16,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(LabelGroup, { children: [
            ...
            !isMinimal ? /* @__PURE__ */ jsx(Label9, { ...stateProps, children: label }) : null
          ] }),
...
var Anchor = styled40(View)`
  position: relative;
  align-self: flex-start;
`;
var Panel2 = styled40(View)`
  position: absolute;
  z-index: 100;
  ...
  box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.4);
`;
var ItemList = styled40(View)`
  flex-direction: column;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var ItemRow = styled40(Pressable)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  padding-horizontal: ${({ theme: theme2 }) => theme2.padding.s}px;
...
`;
var ItemLabel = styled40.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
  color: ${({ $color }) => $color};
`;
var Separator = styled40(View)`
  height: 1px;
  background-color: ${({ theme: theme2 }) => theme2.content.medium};
...
var Container17 = styled40(View)`
  flex-direction: column;
  align-items: stretch;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
`;
var SideMenu = forwardRef(
  ({
    items,
...
var Silhouette = ({
  ...
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      role: "img",
      children: [
        /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsx("linearGradient", { id: gradientId, x1: "0", y1: "0", x2: "0", y2: "1", children: heatGradient ? /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx("stop", { offset: "0", stopColor: "#ef4444" }),
          /* @__PURE__ */ jsx("stop", { offset: "0.33", stopColor: "#f97316" }),
          /* @__PURE__ */ jsx("stop", { offset: "0.66", stopColor: "#facc15" }),
          /* @__PURE__ */ jsx("stop", { offset: "1", stopColor: "#22c55e" })
        ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
...
var ChartFrame = styled40(View)`
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.m}px;
  background-color: ${({ theme: theme2 }) => theme2.surface.medium};
`;
var Layer = styled40(View)`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
  bottom: 0;
`;
var KcalAnchor = styled40(View)`
  position: absolute;
  width: 0;
  align-items: center;
`;
var TimeAnchor = styled40(View)`
  position: absolute;
  width: 0;
  align-items: center;
`;
...
var LineCaloriesChart = forwardRef(
  ({
    points,
    unit = "kcal",
    width = DEFAULT_WIDTH,
        ...
        children: [
            ...
            "svg",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("linearGradient", { id: gradId, x1: "0", y1: "0", x2: "1", y2: "0", children: [
                  /* @__PURE__ */ jsx("stop", { offset: "0%", stopColor: theme2.surface.primary }),
                  /* @__PURE__ */ jsx("stop", { offset: "50%", stopColor: theme2.surface.secondary }),
                  /* @__PURE__ */ jsx("stop", { offset: "100%", stopColor: theme2.surface.warning })
                ] }) }),
                /* @__PURE__ */ jsx(
                  "path",
                  {
          ...
          laid.map((p) => /* @__PURE__ */ jsx(
            KcalAnchor,
            {
              ...
              children: /* @__PURE__ */ jsx(CaloriesTag, { value: p.kcal, unit })
            },
            `k-${p.index}`
          )),
          laid.map((p) => /* @__PURE__ */ jsx(
            TimeAnchor,
            {
              ...
              children: /* @__PURE__ */ jsx(TimeStamp, { time: p.time })
            },
            `t-${p.index}`
          ))
        ]
  ...
  ({
    ...
    const track = /* @__PURE__ */ jsx(
      Track2,
      {
        ...
        testID,
        children: /* @__PURE__ */ jsx(Thumb, { $on: value })
      }
    );
    ...
    return /* @__PURE__ */ jsxs(Row6, { ref, children: [
      ...
      track,
      rightLabel ? /* @__PURE__ */ jsx(SideLabel, { $active: value, $disabled: disabled, children: rightLabel }) : null
    ] });
  }
);
...
var Row7 = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
`;
var TimePill = styled40(View)`
  padding-horizontal: ${({ theme: theme2 }) => theme2.padding.s}px;
  padding-vertical: ${({ theme: theme2 }) => theme2.padding.xs}px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.s}px;
  background-color: ${({ theme: theme2 }) => theme2.surface.standard};
`;
var TimeText2 = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.s}px;
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
`;
var Label10 = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
`;
var WeatherEventChip = forwardRef(
    ...
    return /* @__PURE__ */ jsxs(
      Row7,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(Label10, { children: label })
        ]
      }
    );
  }
...
var Stack = styled40(View)`
  flex-direction: column;
  align-items: flex-start;
  gap: ${({ theme: theme2 }) => theme2.gap.l}px;
`;
var IconRow = styled40(View)`
  flex-direction: row;
  align-items: center;
  justify-content: center;
  align-self: stretch;
...
var Stack2 = styled40(View)`
  flex-direction: row;
  align-items: flex-start;
`;
var Pole = styled40(View)`
  width: 3px;
  height: ${({ $height }) => $height}px;
  background-color: ${({ theme: theme2 }) => theme2.content.dark};
`;
var Flag = styled40(View)`
  width: 80px;
  height: 30px;
  background-color: ${({ theme: theme2 }) => theme2.content.dark};
  align-items: center;
...
`;
var FlagText = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.light};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
`;
var NowMarker = forwardRef(
  ({ label = "AGORA", height = 80, accessibilityLabel, testID }, ref) => {
    return /* @__PURE__ */ jsxs(
      Stack2,
      {
        ...
        testID,
        children: [
          /* @__PURE__ */ jsx(Pole, { $height: height }),
          /* @__PURE__ */ jsx(Flag, { children: /* @__PURE__ */ jsx(FlagText, { children: label }) })
        ]
      }
    );
  }
  ...
  ({
    ...
    return /* @__PURE__ */ jsx(
      Container18,
      {
        ...
        accessibilityLabel: accessibilityLabel ?? text,
        testID,
        children: /* @__PURE__ */ jsx(Label11, { numberOfLines: 1, children: text })
      }
    );
  }
);
StatusTag.displayName = "StatusTag";
var Card5 = styled40(Pressable)`
  flex-direction: column;
  align-items: flex-start;
  gap: 10px;
  padding: ${({ theme: theme2 }) => theme2.padding.m}px;
...
`;
var Section = styled40(View)`
  align-self: stretch;
  flex-direction: column;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var SectionHeading = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${typography.badge.s.fontFamily};
  font-weight: ${typography.badge.s.fontWeight};
  font-size: ${typography.badge.s.fontSize}px;
`;
var SectionBody = styled40.Text`
  align-self: stretch;
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var FooterRow = styled40(View)`
  align-self: stretch;
  flex-direction: row;
  align-items: center;
  justify-content: space-between;
`;
var AuthorBlock = styled40(View)`
  flex: 1;
  min-width: 0;
  flex-direction: column;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var AuthorRow = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var AuthorName = styled40.Text`
  flex: 0 1 auto;
  max-width: 80px;
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${typography.badge.s.fontFamily};
  ...
  font-size: ${typography.badge.s.fontSize}px;
`;
var LocationLabel = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.secondary};
  font-family: ${typography.badge.s.fontFamily};
  font-weight: ${typography.badge.s.fontWeight};
  font-size: ${typography.badge.s.fontSize}px;
  ...
  ({
    ...
    return /* @__PURE__ */ jsxs(
      Card5,
      {
        ...
        children: [
          /* @__PURE__ */ jsx(StatusTag, { status, label: statusLabel }),
          /* @__PURE__ */ jsx(Title3, { children: title }),
          /* @__PURE__ */ jsxs(Section, { children: [
            /* @__PURE__ */ jsx(SectionHeading, { children: summaryLabel }),
            /* @__PURE__ */ jsx(SectionBody, { children: summary })
          ] }),
          /* @__PURE__ */ jsxs(Section, { children: [
            /* @__PURE__ */ jsx(SectionHeading, { children: creationDateLabel }),
            /* @__PURE__ */ jsx(SectionBody, { children: creationDate })
          ] }),
          /* @__PURE__ */ jsxs(FooterRow, { children: [
            /* @__PURE__ */ jsxs(AuthorBlock, { children: [
              /* @__PURE__ */ jsx(SectionHeading, { children: authorLabel }),
              /* @__PURE__ */ jsxs(AuthorRow, { children: [
                /* @__PURE__ */ jsx(Avatar, { uri: author.avatarUri, size: "m" }),
                /* @__PURE__ */ jsx(AuthorName, { numberOfLines: 3, children: author.name })
              ] })
            ] }),
            location ? /* @__PURE__ */ jsx(LocationLabel, { children: location }) : null
          ] }),
          responsibles ? /* @__PURE__ */ jsxs(Section, { children: [
            /* @__PURE__ */ jsx(SectionHeading, { children: responsiblesLabel }),
            /* @__PURE__ */ jsx(SectionBody, { numberOfLines: 1, children: responsibles })
          ] }) : null
        ]
      }
    );
...
var Container19 = styled40(View)`
  flex-direction: column;
  position: relative;
`;
var RulerRow = styled40(View)`
  position: absolute;
  top: 64px;
  left: 0;
  right: 0;
  ...
  z-index: 1;
`;
var RulerLine = styled40(View)`
  width: 1px;
  height: ${({ $major }) => $major ? 20 : 12}px;
  background-color: ${({ theme: theme2 }) => theme2.content.dark};
  opacity: 0.4;
`;
var EventsRow = styled40(View)`
  flex-direction: row;
  align-items: flex-start;
  justify-content: space-between;
`;
var EventColumn = styled40(View)`
  flex: 1;
  min-width: 200px;
  align-items: flex-start;
  position: relative;
...
styled40(View)`
  ...
  position: relative;
`;
var NowFloat = styled40(View)`
  position: absolute;
  top: 40px;
  z-index: 2;
`;
var IntensityRow = styled40(View)`
  flex-direction: row;
  height: 12px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.pill}px;
  overflow: hidden;
...
`;
var IntensitySegmentView = styled40(View)`
  flex: ${({ $flex }) => $flex};
  background-color: ${({ $bg }) => $bg};
`;
var ScrollTrack = styled40(View)`
  height: 8px;
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.l}px;
  background-color: ${({ theme: theme2 }) => theme2.surface.medium};
...
var WeatherTimeline = forwardRef(
  ({
    events,
    intensitySegments,
    nowLabel = "AGORA",
    ...
    const dragInitialScrollRef = useRef(null);
    ...
    const innerContent = /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(EventsRow, { children: events.map((event) => /* @__PURE__ */ jsx(EventColumn, { children: /* @__PURE__ */ jsx(
      ...
      /* @__PURE__ */ jsx(IntensityRow, { children: segments.map((seg) => /* @__PURE__ */ jsx(IntensitySegmentView, { $flex: seg.flex, $bg: seg.color }, seg.id)) }),
      /* @__PURE__ */ jsx(RulerRow, { children: RULER_LINES.map((line) => /* @__PURE__ */ jsx(RulerLine, { $major: line.major }, line.id)) }),
    ...
    return /* @__PURE__ */ jsxs(
      Container19,
      {
        ...
        children: [
          ...
          scrollbarRender ? /* @__PURE__ */ jsx(ScrollTrack, { children: /* @__PURE__ */ jsx(
            ScrollThumb,
            {
...
var Card6 = styled40(View)`
  ...
  background-color: ${({ theme: theme2 }) => theme2.surface.standard};
`;
var HeaderRow = styled40(Pressable)`
  flex-direction: row;
  align-items: center;
  justify-content: space-between;
`;
var UserInfoCluster = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.xxl}px;
`;
var UserData = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
`;
var UserText = styled40(View)`
  flex-direction: column;
  align-items: flex-start;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
  width: 145px;
`;
var NameAge = styled40(View)`
  flex-direction: column;
`;
var NameText = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var AgeText = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var BloodRow = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: 5px;
`;
var BloodText = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.ms}px;
`;
var VerticalDivider = styled40(View)`
  width: 1px;
  height: 56px;
  background-color: ${({ theme: theme2 }) => theme2.content.medium};
`;
var HorizontalDivider = styled40(View)`
  height: 1px;
  align-self: stretch;
  background-color: ${({ theme: theme2 }) => theme2.content.medium};
`;
var RoleStack = styled40(View)`
  flex-direction: column;
  width: 186px;
`;
var RolePrimary = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var RoleSecondary = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var ActionsRow = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
`;
var IconButton2 = styled40(Pressable)`
  flex-direction: row;
  align-items: center;
  justify-content: center;
  padding: ${({ theme: theme2 }) => theme2.padding.sm}px;
  ...
  background-color: ${({ theme: theme2 }) => theme2.surface.high};
`;
var ChevronWrap2 = styled40(View)`
  flex-direction: column;
  align-items: center;
  justify-content: center;
  ...
  padding-vertical: ${({ theme: theme2 }) => theme2.padding.sm}px;
`;
var ExpandedRow = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: 51px;
`;
var AlertsList = styled40(View)`
  flex: 1;
  min-width: 0;
  flex-direction: column;
  gap: ${({ theme: theme2 }) => theme2.gap.sm}px;
`;
var AlertItem = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  align-self: stretch;
`;
var AlertContent = styled40(View)`
  flex: 1;
  min-width: 0;
  flex-direction: column;
  gap: 5px;
`;
var AlertTitle = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.ms}px;
`;
var AlertBody = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.dark};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.regular};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var ActionsColumn = styled40(View)`
  flex-direction: column;
  align-items: flex-start;
  gap: ${({ theme: theme2 }) => theme2.gap.sm}px;
  width: 280px;
`;
var PauseButton = styled40(Pressable)`
  flex-direction: row;
  align-items: center;
  justify-content: center;
  padding: ${({ theme: theme2 }) => theme2.padding.sm}px;
  ...
  align-self: stretch;
`;
var PauseButtonLabel = styled40.Text`
  color: ${({ theme: theme2 }) => theme2.content.light};
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.m}px;
`;
var WorkersInfoCard = forwardRef(
  ({
    employee,
    enabled,
    onEnabledChange,
        ...
        children: [
          /* @__PURE__ */ jsxs(
            HeaderRow,
            {
              ...
              children: [
                /* @__PURE__ */ jsxs(UserInfoCluster, { children: [
                  /* @__PURE__ */ jsxs(UserData, { children: [
                    /* @__PURE__ */ jsx(Avatar, { uri: employee.avatarUri, size: "l", bordered: true }),
                    /* @__PURE__ */ jsxs(UserText, { children: [
                      /* @__PURE__ */ jsxs(NameAge, { children: [
                        /* @__PURE__ */ jsx(NameText, { numberOfLines: 1, children: employee.name }),
                        /* @__PURE__ */ jsx(AgeText, { children: `${employee.age} anos` })
                      ] }),
                      /* @__PURE__ */ jsxs(BloodRow, { children: [
                        /* @__PURE__ */ jsx(Icon, { name: "humidity_mid", size: 20, color: theme2.surface.error }),
                        /* @__PURE__ */ jsx(BloodText, { children: employee.bloodType })
                      ] })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsx(VerticalDivider, {}),
                  /* @__PURE__ */ jsxs(RoleStack, { children: [
                    /* @__PURE__ */ jsx(RolePrimary, { numberOfLines: 1, children: employee.role }),
                    employee.secondaryRole ? /* @__PURE__ */ jsx(RoleSecondary, { numberOfLines: 1, children: employee.secondaryRole }) : null
                  ] }),
                  /* @__PURE__ */ jsx(VerticalDivider, {}),
                  /* @__PURE__ */ jsx(Toggle, { value: enabled, onChange: onEnabledChange })
                ] }),
                /* @__PURE__ */ jsxs(ActionsRow, { children: [
                  onDelete ? /* @__PURE__ */ jsx(IconButton2, { onPress: onDelete, accessibilityRole: "button", accessibilityLabel: "Excluir", children: /* @__PURE__ */ jsx(Icon, { name: "delete_icon", size: 24, color: theme2.content.dark }) }) : null,
                  onChat ? /* @__PURE__ */ jsx(IconButton2, { onPress: onChat, accessibilityRole: "button", accessibilityLabel: "Mensagem", children: /* @__PURE__ */ jsx(Icon, { name: "chat_bubble", size: 24, color: theme2.content.dark }) }) : null,
                  onLocation ? /* @__PURE__ */ jsx(IconButton2, { onPress: onLocation, accessibilityRole: "button", accessibilityLabel: "Localiza\xE7\xE3o", children: /* @__PURE__ */ jsx(Icon, { name: "location_on", size: 24, color: theme2.content.dark }) }) : null
                ] }),
                /* @__PURE__ */ jsx(ChevronWrap2, { children: /* @__PURE__ */ jsx(
                  Icon,
                  {
          ...
          expanded ? /* @__PURE__ */ jsxs(Fragment, { children: [
            ...
            /* @__PURE__ */ jsxs(ExpandedRow, { children: [
              /* @__PURE__ */ jsx(AlertsList, { children: alerts.map((alert, idx) => /* @__PURE__ */ jsxs(AlertItem, { children: [
                /* @__PURE__ */ jsx(Icon, { name: alert.icon, size: 24, color: theme2.content.dark }),
                /* @__PURE__ */ jsxs(AlertContent, { children: [
                  /* @__PURE__ */ jsx(AlertTitle, { children: alert.title }),
                  /* @__PURE__ */ jsx(AlertBody, { children: alert.description })
                ] })
              ] }, `${alert.title}-${idx}`)) }),
              /* @__PURE__ */ jsxs(ActionsColumn, { children: [
                onExamHistory ? /* @__PURE__ */ jsx(
                  Button,
                  {
                ...
                onSendBreakAlert ? /* @__PURE__ */ jsx(
                  PauseButton,
                  {
                    ...
                    style: elevation.md,
                    children: /* @__PURE__ */ jsx(PauseButtonLabel, { children: sendBreakAlertLabel })
                  }
                ) : null
              ] })
            ] })
...
var InnerShadowCircle = ({ size, fill, dy, blur, alpha }) => {
  ...
  return /* @__PURE__ */ jsxs("svg", { width: size, height: size, style: { pointerEvents: "none" }, children: [
    /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("filter", { id: filterId, x: "-10%", y: "-10%", width: "120%", height: "120%", children: [
      ...
      /* @__PURE__ */ jsx("feGaussianBlur", { stdDeviation: blur }),
      ...
      /* @__PURE__ */ jsx("feBlend", { mode: "normal", in2: "shape", result: "effect_innerShadow" })
    ] }) }),
    /* @__PURE__ */ jsx("circle", { cx: r, cy: r, r, fill, filter: `url(#${filterId})` })
  ] });
};
    ...
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("defs", { children: [
          ...
          /* @__PURE__ */ jsx("clipPath", { id: progressClipId, children: /* @__PURE__ */ jsx("path", { d: sectorD }) }),
          /* @__PURE__ */ jsxs("filter", { id: innerShadowId, x: "-10%", y: "-10%", width: "120%", height: "120%", children: [
            /* @__PURE__ */ jsx("feFlood", { floodOpacity: "0", result: "BackgroundImageFix" }),
            /* @__PURE__ */ jsx("feBlend", { mode: "normal", in: "SourceGraphic", in2: "BackgroundImageFix", result: "shape" }),
            /* @__PURE__ */ jsx(
              "feColorMatrix",
            ...
            /* @__PURE__ */ jsx("feOffset", { dy: "2.08" }),
            /* @__PURE__ */ jsx("feGaussianBlur", { stdDeviation: "2.08" }),
            /* @__PURE__ */ jsx("feComposite", { in2: "hardAlpha", operator: "arithmetic", k2: -1, k3: 1 }),
            /* @__PURE__ */ jsx(
              "feColorMatrix",
              {
...
var BUTTON_DROP_SHADOW = Platform.select({
  ios: {
    shadowColor: "#000",
...
var BUTTON_INSET_SHADOW = Platform.OS === "web" ? { boxShadow: "inset 0px 2.178px 4.356px rgba(0,0,0,0.59)" } : void 0;
var BUTTON_CONTAINER_SIZE = 68.974;
var BUTTON_CONTAINER_R = BUTTON_CONTAINER_SIZE / 2;
var BUTTON_CONTAINER_DROP_SHADOW = Platform.select({
  ios: {
    shadowColor: "#000",
...
var StatusChart = ({
      ...
      children: [
        ...
        renderHeartStatus ? /* @__PURE__ */ jsx(
          View,
          {
            ...
            pointerEvents: "none",
            children: /* @__PURE__ */ jsx(HeartStatus, { condition: p.heartStatus, size: HEART_STATUS_OFFSET.height })
          }
        ) : null,
        showActionButton ? /* @__PURE__ */ jsxs(
          Pressable,
          {
            ...
            children: [
              ...
              BUTTON_INSET_SHADOW ? /* @__PURE__ */ jsx(
                View,
                {
                  pointerEvents: "none",
                  style: [
  ...
  return /* @__PURE__ */ jsx(View, { style: { width: outerW, height: outerH, overflow: "hidden" }, children: /* @__PURE__ */ jsx(
    View,
    {
      style: {
        width: STATUS_CHART_CANVAS.width,
...
var Step = ({ state, number, testID, accessibilityLabel }) => /* @__PURE__ */ jsx(
  Dot2,
  {
    ...
    children: /* @__PURE__ */ jsx(Label12, { $state: state, children: renderContent(state, number) })
  }
);
Step.displayName = "Step";
var Container20 = styled40(View)`
  flex-direction: row;
  align-items: center;
  align-self: stretch;
`;
var Connector = styled40(View)`
  flex: 1;
  height: 4px;
  border-radius: 2px;
  background-color: ${({ $reached, theme: theme2 }) => $reached ? theme2.content.primary : theme2.content.medium};
`;
var GradientTrack = styled40(View)`
  flex: 1;
  height: 4px;
  border-radius: 2px;
  overflow: hidden;
...
var GradientConnector = () => /* @__PURE__ */ jsx(GradientTrack, { children: /* @__PURE__ */ jsxs(Svg, { width: "100%", height: "100%", viewBox: "0 0 100 4", preserveAspectRatio: "none", children: [
  /* @__PURE__ */ jsx(Defs, { children: /* @__PURE__ */ jsxs(LinearGradient, { id: "stepbar-reached", x1: "0", y1: "0", x2: "100", y2: "0", gradientUnits: "userSpaceOnUse", children: [
    /* @__PURE__ */ jsx(Stop, { offset: "0%", stopColor: "#8AD2E2" }),
    /* @__PURE__ */ jsx(Stop, { offset: "100%", stopColor: "#62BB81" })
  ] }) }),
  /* @__PURE__ */ jsx(Rect, { x: 0, y: 0, width: 100, height: 4, fill: "url(#stepbar-reached)" })
] }) });
  ...
  Container20,
  {
    ...
    children: Array.from({ length: total }, (_, idx) => {
      ...
      return /* @__PURE__ */ jsxs(Fragment$1, { children: [
        ...
        idx < total - 1 ? reached ? /* @__PURE__ */ jsx(GradientConnector, {}) : /* @__PURE__ */ jsx(Connector, { $reached: false }) : null
      ] }, stepNum);
    })
  }
);
StepBar.displayName = "StepBar";
var Container21 = styled40(Pressable)`
  flex: 1;
  flex-direction: column;
  align-items: center;
  justify-content: center;
  ...
  border-color: ${({ theme: theme2 }) => theme2.content.primary};
`;
var IconSlot7 = styled40(View)`
  width: 24px;
  height: 24px;
  align-items: center;
  justify-content: center;
`;
var Label13 = styled40.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: 12px;
  ...
  return /* @__PURE__ */ jsxs(
    Container21,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(Label13, { $selected: selected, children: label })
      ]
    }
  );
};
GenderSelectionCard.displayName = "GenderSelectionCard";
var Row8 = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  align-self: stretch;
`;
var Container22 = styled40(View)`
  flex-direction: column;
  align-self: stretch;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var Description4 = styled40.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  color: ${(props) => descriptionColor(props)};
...
var GenderSelector = ({
  ...
  /* @__PURE__ */ jsxs(Container22, { testID, accessibilityRole: "radiogroup", children: [
    /* @__PURE__ */ jsxs(Row8, { children: [
      /* @__PURE__ */ jsx(
        GenderSelectionCard,
        {
          gender: "female",
    ...
    description ? /* @__PURE__ */ jsx(Description4, { $variant: descriptionVariant, children: description }) : null
  ] })
);
GenderSelector.displayName = "GenderSelector";
var Container23 = styled40(View)`
  flex-direction: column;
  gap: ${({ theme: theme2 }) => theme2.gap.m}px;
  align-self: stretch;
`;
var SyncRow = styled40(View)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.s}px;
  align-self: stretch;
`;
var SyncCell = styled40(View)`
  flex: 1;
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
  ...
  border-radius: ${({ theme: theme2 }) => theme2.border.radius.xs}px;
`;
var IconSlot8 = styled40(View)`
  width: 56px;
  height: 56px;
  align-items: center;
  justify-content: center;
`;
var Value2 = styled40.Text`
  flex: 1;
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.title};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.bold};
  font-size: 32px;
...
var SmartbandStatus = ({
  ...
  return /* @__PURE__ */ jsxs(Container23, { testID, accessibilityLabel: accessibilityLabel ?? message, children: [
    /* @__PURE__ */ jsx(ProgressBar, { value: progress * 100 }),
    /* @__PURE__ */ jsxs(SyncRow, { children: [
      /* @__PURE__ */ jsxs(SyncCell, { children: [
        /* @__PURE__ */ jsx(IconSlot8, { children: /* @__PURE__ */ jsx(Icon, { name: "favorite", size: 47, color: heartColor }) }),
        /* @__PURE__ */ jsx(Value2, { $active: heartActive, children: heartRate != null ? String(heartRate) : "/" })
      ] }),
      /* @__PURE__ */ jsxs(SyncCell, { children: [
        /* @__PURE__ */ jsx(IconSlot8, { children: /* @__PURE__ */ jsx(Icon, { name: "blood_pressure", size: 47, color: pressureColor }) }),
        /* @__PURE__ */ jsx(Value2, { $active: pressureActive, children: bloodPressure != null ? bloodPressure : "/" })
      ] })
    ] }),
...
var Container24 = styled40(View)`
  flex-direction: row;
  align-items: center;
  ${({ $separated, theme: theme2 }) => $separated ? `gap: ${theme2.gap.s}px;` : ""};
`;
var Tab = styled40(Pressable)`
  align-items: center;
  justify-content: center;
  padding-horizontal: ${({ theme: theme2 }) => theme2.padding.s}px;
  padding-vertical: ${({ theme: theme2 }) => theme2.padding.s}px;
        ...
        children: tabs.map((tab, idx) => {
          ...
          return /* @__PURE__ */ jsx(
            Tab,
            {
              ...
              children: /* @__PURE__ */ jsx(TabLabel, { $active: isActive, numberOfLines: 1, children: tab.label })
            },
            tab.value
          );
        })
...
var StatusIcon = ({ variant, color }) => /* @__PURE__ */ jsx(
  View,
  {
    style: {
      width: 24,
...
var CloseIcon = ({ color }) => /* @__PURE__ */ jsxs(
  View,
  {
    style: {
      width: 24,
...
`;
var MessageContainer = styled40(View)`
  flex: 1;
  flex-direction: column;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
`;
var Title4 = styled40.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  color: ${({ theme: theme2 }) => theme2.content.light};
`;
var Message2 = styled40.Text`
  font-family: ${({ theme: theme2 }) => theme2.fontFamily.body};
  font-weight: ${({ theme: theme2 }) => theme2.fontWeight.medium};
  font-size: ${({ theme: theme2 }) => theme2.fontSize.sm}px;
  color: ${({ theme: theme2 }) => theme2.content.light};
  ...
  ({ variant = "info", title, message, onClose, accessibilityLabel, testID }, ref) => {
    ...
    return /* @__PURE__ */ jsxs(
      Container25,
      {
        ...
        testID,
        children: [
          /* @__PURE__ */ jsx(StatusIcon, { variant, color: theme2.content.light }),
          /* @__PURE__ */ jsxs(MessageContainer, { children: [
...
`;
var BackSlot = styled40(Pressable)`
  flex-direction: row;
  align-items: center;
  gap: ${({ theme: theme2 }) => theme2.gap.xs}px;
  margin-left: -6px;
...
var TopBar = forwardRef(
  ({ title, onBack, backLabel = "Voltar", accessibilityLabel, testID }, ref) => {
    ...
    return /* @__PURE__ */ jsxs(Container26, { ref, testID, children: [
