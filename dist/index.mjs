...
import Svg, { Defs, LinearGradient, Stop, Rect, Path, Circle, G, ClipPath } from 'react-native-svg';
...
var BackgroundDotsGrid = ({
  ...
  return /* @__PURE__ */ jsx(
    View,
    {
      ...
      pointerEvents: "none",
      testID,
      children: /* @__PURE__ */ jsx(Svg, { width: "100%", height: "100%", viewBox, children: Array.from({ length: columns }, (_, i) => /* @__PURE__ */ jsx(G, { transform: `translate(${i * COL_SPACING} 0)`, children: COL_DOTS.map((d, di) => /* @__PURE__ */ jsx(Circle, { cx: COL_CENTER_X, cy: d.cy, r: d.r, fill: color }, di)) }, i)) })
    }
  );
};
...
var Combobox = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs(Container11, { ref, testID, $open: isOpen && !disabled, children: [
    ...
    Svg,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs(Defs, { children: [
          /* @__PURE__ */ jsxs(LinearGradient, { id: silhouetteGradId, x1: "0", y1: "0", x2: "0", y2: "1", children: [
        ...
        layer === "lower" ? /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(Circle, { cx: CENTER_X, cy: CENTER_Y, r: BG_R, fill: theme2.surface.standard }),
          /* @__PURE__ */ jsx(Circle, { cx: CENTER_X, cy: CENTER_Y, r: INNER_BG_R, fill: theme2.surface.medium })
        ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(Circle, { cx: CENTER_X, cy: CENTER_Y, r: TRACK_R, fill: theme2.surface.high }),
          ...
          /* @__PURE__ */ jsx(Circle, { cx: CENTER_X, cy: CENTER_Y, r: WELL_R, fill: theme2.background }),
          /* @__PURE__ */ jsx(
            Path,
            {
              d: STATUS_GAUGE.d,
