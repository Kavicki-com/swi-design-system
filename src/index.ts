...
export { BackgroundDotsGrid } from './components/BackgroundDotsGrid';
export type { BackgroundDotsGridProps } from './components/BackgroundDotsGrid';
...
export { JourneyTheme } from './components/JourneyTheme';
export type { JourneyThemeProps } from './components/JourneyTheme';
